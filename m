Return-Path: <linux-integrity+bounces-9725-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 2KEzNCG8HmrZJgAAu9opvQ
	(envelope-from <linux-integrity+bounces-9725-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Tue, 02 Jun 2026 13:18:57 +0200
X-Original-To: lists+linux-integrity@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [IPv6:2600:3c15:e001:75::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id D35B662D4CE
	for <lists+linux-integrity@lfdr.de>; Tue, 02 Jun 2026 13:18:56 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 18FE43018A04
	for <lists+linux-integrity@lfdr.de>; Tue,  2 Jun 2026 11:15:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 88F593D564F;
	Tue,  2 Jun 2026 11:15:13 +0000 (UTC)
X-Original-To: linux-integrity@vger.kernel.org
Received: from frasgout12.his.huawei.com (frasgout12.his.huawei.com [14.137.139.154])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0A1183D3D19;
	Tue,  2 Jun 2026 11:15:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=14.137.139.154
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1780398913; cv=none; b=fR+AnNiwBcucGGT7nDWB4UKvsJeagXt4to/8iRVL242AVkVCrau9Hvvxx2cDejhK2g5bwKNOVWFi1Zm5pQzXu61GPg3KxqDlfqbwCGAqhHQ31OZ8jWHUnIl5Qefe0zaALZFr7aVSk8ewbAuF8m3VLS8zjT0iKCnYfVeeKOrHOao=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1780398913; c=relaxed/simple;
	bh=BNA2CUESf+yHW0POrSULtI1TMqwIbV68I0AGqtEn3fU=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Li8YdmCbwhzH7hwaxRckWUD0r0Ix8Cf58mLMpUaq6AyxHC/VErlwY0imJVt1zzjS5JNQfNzyLKdmKhrajaDH1XC2qn+Wl/Zh+gI6Io7BFktEmQb6a1sW6z+uxrCrbRpvVnSINdmL+1Vu+emfGbfmq41JPe6xV24T+LbprlE2sqY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=huaweicloud.com; spf=pass smtp.mailfrom=huaweicloud.com; arc=none smtp.client-ip=14.137.139.154
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=huaweicloud.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huaweicloud.com
Received: from mail.maildlp.com (unknown [172.18.224.235])
	by frasgout12.his.huawei.com (SkyGuard) with ESMTPS id 4gV7Qr0QG0zxYPP;
	Tue,  2 Jun 2026 19:10:12 +0800 (CST)
Received: from mail02.huawei.com (unknown [7.182.16.47])
	by mail.maildlp.com (Postfix) with ESMTP id 6552A4056C;
	Tue,  2 Jun 2026 19:15:07 +0800 (CST)
Received: from huaweicloud.com (unknown [10.204.63.22])
	by APP1 (Coremail) with SMTP id LxC2BwA3o84fux5qKBozAA--.30704S4;
	Tue, 02 Jun 2026 12:15:06 +0100 (CET)
...
Subject: [PATCH v6 02/12] ima: Replace static htable queue with dynamically allocated array
Date: Tue,  2 Jun 2026 13:13:51 +0200
Message-ID: <20260602111401.1706052-3-roberto.sassu@huaweicloud.com>
...
X-CM-TRANSID:LxC2BwA3o84fux5qKBozAA--.30704S4
X-Coremail-Antispam: 1UD129KBjvJXoW3Xw1fuw45Kr1fCr4rKryxGrg_yoWxAF18pa
	...
	UUUU=
X-CM-SenderInfo: purev21wro2thvvxqx5xdzvxpfor3voofrz/1tbiAQAMBGoeRsQEdQACsM
X-Rspamd-Queue-Id: D35B662D4CE
...
X-Spamd-Result: default: False [1.54 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-9725-lists,linux-integrity=lfdr.de];

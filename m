...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1F690628C12
	for <lists+linux-integrity@lfdr.de>; Mon, 14 Nov 2022 23:25:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237327AbiKNWZU (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Mon, 14 Nov 2022 17:25:20 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58522 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237266AbiKNWZT (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Mon, 14 Nov 2022 17:25:19 -0500
Received: from mx0a-001b2d01.pphosted.com (mx0b-001b2d01.pphosted.com [148.163.158.5])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AD801FADC
        for <linux-integrity@vger.kernel.org>; Mon, 14 Nov 2022 14:25:15 -0800 (PST)
Received: from pps.filterd (m0098419.ppops.net [127.0.0.1])
        by mx0b-001b2d01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 2AEM2dJ7019992;
        Mon, 14 Nov 2022 22:25:10 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=from : to : cc : subject
 : date : message-id : content-type : content-transfer-encoding :
 mime-version; s=pp1; bh=cKQAcpcWrH0CYJws+ZeKx91W6Y4w8grtNEocZy1xupY=;
 b= NA== 
Received: from ppma01fra.de.ibm.com (46.49.7a9f.ip4.static.sl-reverse.com [159.122.73.70])
        by mx0b-001b2d01.pphosted.com (PPS) with ESMTPS id 3kux4f8j27-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Mon, 14 Nov 2022 22:25:10 +0000
Received: from pps.filterd (ppma01fra.de.ibm.com [127.0.0.1])
        by ppma01fra.de.ibm.com (8.16.1.2/8.16.1.2) with SMTP id 2AEMKGia017631;
        Mon, 14 Nov 2022 22:25:08 GMT
Received: from b06cxnps3075.portsmouth.uk.ibm.com (d06relay10.portsmouth.uk.ibm.com [9.149.109.195])
        by ppma01fra.de.ibm.com with ESMTP id 3ktbd9j3dj-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Mon, 14 Nov 2022 22:25:08 +0000
Received: from d06av22.portsmouth.uk.ibm.com (d06av22.portsmouth.uk.ibm.com [9.149.105.58])
        by b06cxnps3075.portsmouth.uk.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 2AEMP51T590528
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Mon, 14 Nov 2022 22:25:05 GMT
Received: from d06av22.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id 9355C4C040;
        Mon, 14 Nov 2022 22:25:05 +0000 (GMT)
Received: from d06av22.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id 9FBAF4C044;
        Mon, 14 Nov 2022 22:25:04 +0000 (GMT)
...
Subject: [RFC PATCH ima-evm-utils] Save ima-evm-utils sourceforge wiki
Date:   Mon, 14 Nov 2022 17:24:51 -0500
Message-Id: <20221114222451.832058-1-zohar@linux.ibm.com>
X-Mailer: git-send-email 2.31.1
Content-Type: text/plain; charset=UTF-8
X-TM-AS-GCONF: 00
X-Proofpoint-ORIG-GUID: 9zf9SKH31OQCPmQppyzutRLrC3Y_0G9y
X-Proofpoint-GUID: 9zf9SKH31OQCPmQppyzutRLrC3Y_0G9y
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 mlxscore=0 clxscore=1015
 ...
 definitions=main-2211140156
X-Spam-Status: No, score=0.5 required=5.0 tests=BAYES_00,CONTENT_AFTER_HTML,
        DKIM_SIGNED,DKIM_VALID,DKIM_VALID_EF,HEXHASH_WORD,RCVD_IN_MSPIKE_H2,
        SPF_HELO_NONE,SPF_PASS,URI_NOVOWEL autolearn=no autolearn_force=no
        version=3.4.6
...
---
Comments:
- Initial version never made it to the mailing list due to size
  limitation. Reposting trimmed version.
- Instead of putting the files directly in doc, put them in doc/sf.

 Makefile.am            |   2 +-
 configure.ac           |   2 +
 doc/Makefile.am        |   1 +
 doc/sf/Makefile.am     |   6 +
 doc/sf/sf-diagram.html |  46 ++
 doc/sf/sf-tcg.html     |  99 +++++
 doc/sf/sf-wiki.md      | 932 +++++++++++++++++++++++++++++++++++++++++
 7 files changed, 1087 insertions(+), 1 deletion(-)
 create mode 100644 doc/Makefile.am
 create mode 100644 doc/sf/Makefile.am
 create mode 100644 doc/sf/sf-diagram.html
 create mode 100644 doc/sf/sf-tcg.html
 create mode 100644 doc/sf/sf-wiki.md

diff --git a/Makefile.am b/Makefile.am
index 17fd478eff2f..4ae64ad22350 100644
--- a/Makefile.am
+++ b/Makefile.am
@@ -1,4 +1,4 @@
-SUBDIRS = src tests
...
index 90646da22061..0d69d059ed80 100644
--- a/configure.ac
+++ b/configure.ac
@@ -79,6 +79,8 @@ AX_DEFAULT_HASH_ALGO([$KERNEL_HEADERS])
...
index 000000000000..a75e3b9dd94a
--- /dev/null
+++ b/doc/Makefile.am
@@ -0,0 +1 @@
+SUBDIRS = sf
diff --git a/doc/sf/Makefile.am b/doc/sf/Makefile.am
new file mode 100644
index 000000000000..6c4158cb216e
--- /dev/null
+++ b/doc/sf/Makefile.am
@@ -0,0 +1,6 @@
...
diff --git a/doc/sf/sf-diagram.html b/doc/sf/sf-diagram.html
new file mode 100644
index 000000000000..8c4d8b7bde90
--- /dev/null
+++ b/doc/sf/sf-diagram.html
@@ -0,0 +1,46 @@
...
+</P>
+</BODY></HTML>
diff --git a/doc/sf/sf-tcg.html b/doc/sf/sf-tcg.html
new file mode 100644
index 000000000000..6a7fd7820f7f
--- /dev/null
+++ b/doc/sf/sf-tcg.html
@@ -0,0 +1,99 @@
+<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
+<HTML>
+<STYLE TYPE="text/css">
...
+</BODY>
+</HTML>
diff --git a/doc/sf/sf-wiki.md b/doc/sf/sf-wiki.md
new file mode 100644
index 000000000000..97aa44c8f21a
--- /dev/null
+++ b/doc/sf/sf-wiki.md
@@ -0,0 +1,932 @@

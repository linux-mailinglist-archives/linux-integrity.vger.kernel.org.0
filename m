...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B37112A0AAF
	for <lists+linux-integrity@lfdr.de>; Fri, 30 Oct 2020 17:06:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726407AbgJ3QGt (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Fri, 30 Oct 2020 12:06:49 -0400
Received: from us-smtp-delivery-124.mimecast.com ([216.205.24.124]:46225 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1725355AbgJ3QGt (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Fri, 30 Oct 2020 12:06:49 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1604074007;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=B+m74E0XyPJblVAfhFmve7PcOMmpRo89SMi1W60lwis=;
        b=UEFjHQuIFd3/cmx5MGMAGZFk1+jLwzIRQxwOcWpkAhy3VbOhi9868WDIxwBHyiwwoHLAEQ
        ibIgmJf95KWwh1rNr7caF1m+foqOmaL7Wo+9c4E+k9sotw7cx2m/iEQqIO/43gGu5h6a/+
        9VA9z+/NbbWzOcgmPtVraLv6PZncxS8=
Received: from mail-oo1-f69.google.com (mail-oo1-f69.google.com
 [209.85.161.69]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-353-l_vaB45FMY-h3PxKJ7wdsg-1; Fri, 30 Oct 2020 12:06:46 -0400
X-MC-Unique: l_vaB45FMY-h3PxKJ7wdsg-1
Received: by mail-oo1-f69.google.com with SMTP id 29so3013317oot.11
        for <linux-integrity@vger.kernel.org>; Fri, 30 Oct 2020 09:06:45 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:references:user-agent:from:to:cc:subject
         :in-reply-to:date:message-id:mime-version;
        bh=B+m74E0XyPJblVAfhFmve7PcOMmpRo89SMi1W60lwis=;
        b=
X-Gm-Message-State: AOAM531EcP4P7oM915AsNTL7Ag+hMfcGd8Xja4nrjx5QlvbWEGGEuQ48
        Z0XGdGxgBM3FaUPb2s6D6u4aahQVJDDcMb3Miy9PHlW1ILdiqst3+xbSeGLh58+mlDMUaFGCe2q
        OQ/welqDLSWlAAkF2HyIbC10vCtTy
X-Received: by 2002:aca:670b:: with SMTP id z11mr2073199oix.116.1604074004108;
        Fri, 30 Oct 2020 09:06:44 -0700 (PDT)
X-Google-Smtp-Source: ABdhPJwn4fooiHB/2+7GClgPAFS+GTjyvOIb0UgEgMk9IHdxwBqptRICq4jHBS9Opy7CcDjZYZXusw==
X-Received: by 2002:aca:670b:: with SMTP id z11mr2073179oix.116.1604074003844;
        Fri, 30 Oct 2020 09:06:43 -0700 (PDT)
Received: from localhost (ip98-179-76-75.ph.ph.cox.net. [98.179.76.75])
        by smtp.gmail.com with ESMTPSA id b7sm1411108oic.36.2020.10.30.09.06.40
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 30 Oct 2020 09:06:42 -0700 (PDT)
References: <20201001180925.13808-1-James.Bottomley@HansenPartnership.com>
 <20201001180925.13808-4-James.Bottomley@HansenPartnership.com>
 <87zh4h7nz1.fsf@redhat.com> <20201024121553.GB32960@kernel.org>
 <20201030121838.GC522355@kernel.org>
...
Subject: Re: [PATCH v2 3/5] tpm_tis: Fix interrupts for TIS TPMs without
 legacy cycles
In-reply-to: <20201030121838.GC522355@kernel.org>
Date:   Fri, 30 Oct 2020 09:06:39 -0700
Message-ID: <87v9erbsvk.fsf@redhat.com>
MIME-Version: 1.0

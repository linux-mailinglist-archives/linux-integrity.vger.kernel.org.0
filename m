Return-Path: <linux-integrity+bounces-2095-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id C28728A3C65
	for <lists+linux-integrity@lfdr.de>; Sat, 13 Apr 2024 13:01:46 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 39E731F21B66
	for <lists+linux-integrity@lfdr.de>; Sat, 13 Apr 2024 11:01:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4C2463D57A;
	Sat, 13 Apr 2024 11:01:42 +0000 (UTC)
...
Received: from mail-ej1-f46.google.com (mail-ej1-f46.google.com [209.85.218.46])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9BAAF2110B
	for <linux-integrity@vger.kernel.org>; Sat, 13 Apr 2024 11:01:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.46
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713006102; cv=none; b=hFHT0BdJVJ+gBcdXdSDEVi9BhCjJXIfYNZKExCLjBT8akvaZeAfTZWy3btacI+yXcddiMLuFoS7Y3nogRoulLXPD7OgG/iPe/GC+2JneVJhUPaaDEs6RVxyow/UCyy18KET/Aujfc110Xmhk0Wr3UQvxKGO0LU7Ffd/KhZFclUI=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=mUBxHPx5; arc=none smtp.client-ip=209.85.218.46
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-ej1-f46.google.com with SMTP id a640c23a62f3a-a523e1372b2so131447366b.1
        for <linux-integrity@vger.kernel.org>; Sat, 13 Apr 2024 04:01:40 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:from
         ...
         :message-id:reply-to;
        bh=cXDU16Ou8ZyDMO2AM+8sVodEeRZtWf6krx3rzx7SIrM=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU8N/nR0hq8frwi0SRtOMKcSKOEZn5R1gZqyEUHcXTC+8odFmwCm3Maay7x7wSXeA2cjOQCbyZmJGhfxsp+kGpgK6zETFmeBumBC2PCphnu
X-Gm-Message-State: AOJu0YzWGAT+7kTtGpH+ROsWDz1QM7Y8elb8JX814ZYwemzCJdi0Gfah
	wbMrEjBQDaYDr5JoSsyvCJp3VMmvlPkdhLdejdUKBxR70E9hnS/TDKtqnyZGCog=

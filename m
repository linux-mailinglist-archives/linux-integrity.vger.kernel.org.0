Return-Path: <linux-integrity+bounces-1861-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1227088B1E8
	for <lists+linux-integrity@lfdr.de>; Mon, 25 Mar 2024 21:47:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 7B35DC241B2
	for <lists+linux-integrity@lfdr.de>; Mon, 25 Mar 2024 18:02:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E5DA6433DF;
...
Received: from mail-yw1-f178.google.com (mail-yw1-f178.google.com [209.85.128.178])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 44F065672
	for <linux-integrity@vger.kernel.org>; Mon, 25 Mar 2024 17:21:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.178
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711387294; cv=none; b=gSMi1fiXoo923LCiO7xPche14mkL7owHXdO8gsjLR+u4As4lNNNjQfxmZvvZOn50kYvxNt8o8D9nE+p28pckoxTWpl8MQimfOhog/eoZJVMR8iUvGDC3CSilhG9Dj/18/uLQh+Ceu4jSJ5ps2sdJ6L+vHeHcsf3ZqMsOp2GhhIo=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=paul-moore.com; spf=pass smtp.mailfrom=paul-moore.com; dkim=pass (2048-bit key) header.d=paul-moore.com header.i=@paul-moore.com header.b=YTTx+L+K; arc=none smtp.client-ip=209.85.128.178
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=paul-moore.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=paul-moore.com
Received: by mail-yw1-f178.google.com with SMTP id 00721157ae682-609f4155b76so49848967b3.1
        for <linux-integrity@vger.kernel.org>; Mon, 25 Mar 2024 10:21:32 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=GwFJJMO8Y9QW/VnLPngFZc/sbeBlDHZAU2bsUzRDf74=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVo44OcpnB+Gnu99zhvJMsFhJ7iljecWUm/zz4+cvp/mJ0tUXmlRWLNUszh/2ioTUoZtWzqMdYzVvrccXZVeKZDt77yad0Lu8/FrmYMwS4F
X-Gm-Message-State: AOJu0YwNdazAlQuR1/UUIVKAIRFaeb2hUYZrNRDdQQziG/PRzTcha3bh
	oxVTvlXTZSOE7/BtR4TeB/0ZnccsSQcgX3AnBVghwGIIcUjaNg1m+LSzxaj2U258ojHZpGMZBtC
	Y2429KTmCT4qB4C/nCo8lTjKzEq6GNHDdu+GO+YE5gQOf1sYzLA==

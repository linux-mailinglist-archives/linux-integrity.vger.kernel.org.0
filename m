Return-Path: <linux-integrity+bounces-7141-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 84190B7F3B5
	for <lists+linux-integrity@lfdr.de>; Wed, 17 Sep 2025 15:27:03 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 815E53A8C2D
	for <lists+linux-integrity@lfdr.de>; Wed, 17 Sep 2025 02:33:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DDF0C101F2;
	Wed, 17 Sep 2025 02:33:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b="AdLzXxuf"
X-Original-To: linux-integrity@vger.kernel.org
Received: from lamorak.hansenpartnership.com (lamorak.hansenpartnership.com [198.37.111.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 59C6E1AF0C8
	for <linux-integrity@vger.kernel.org>; Wed, 17 Sep 2025 02:33:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.37.111.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1758076427; cv=none; b=G3GH0k5OyEOiZ9RksEbu563j3dugNhz+HcbgD9MjLej3xR0oj5UU6MW2uHYVrKAQduz47MSj8N4KzqPQxJPRTwOwtjUJu56l4xmkZsSG7Zyx9VjT4wB4+cKbw2x8ZYrTlloUua7zfzlIdmaqqUThZ7nu4EvXk8Tj/TUft1Q2PWE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1758076427; c=relaxed/simple;
	bh=3RzhtGr4Du2Z8FYF8PIc2U8D+zxZ1/geYJerqht46tQ=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=qwra1Cofdg1vFJrIADIWimkxpIS/Q0FeSQd7hhzu1GrAkEBhFB+mJo02kv/0ZGwi1gUyDMVhFZeAslVJyN6+ld6oEMmz0A8ihHDWITcuixr7qvEUOYU+pXQm6a7PoymrXhVCcuPyDF3JQ6iZigqJm0oYKd6hAnMZs+j4zji/pzo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com; spf=pass smtp.mailfrom=HansenPartnership.com; dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b=AdLzXxuf; arc=none smtp.client-ip=198.37.111.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=HansenPartnership.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=hansenpartnership.com; s=20151216; t=1758076424;
	bh=3RzhtGr4Du2Z8FYF8PIc2U8D+zxZ1/geYJerqht46tQ=;
	h=Message-ID:Subject:From:To:Date:In-Reply-To:References:From;
	b=AdLzXxufnnISAVNyvd3miBhYBi9KcIL+WImbato33Yb4eZ19JHCyqq3y1WFavtNuG
	 rGUq0HdXUhhxVQezbQrfF6sFWPxxtdLXep7NOz2leNYRXIJa0Y7w3VbsxkJJrINuHm
	 3hR4Py7Ly1OTnmcZlLY0Cz1sDqa9D3U9qzhd19lU=
Received: from lingrow.int.hansenpartnership.com (unknown [IPv6:2601:5c4:4302:c21::a774])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519)
	(No client certificate requested)
	by lamorak.hansenpartnership.com (Postfix) with ESMTPSA id 1B6361C02FB;
	Tue, 16 Sep 2025 22:33:44 -0400 (EDT)
Message-ID: <8c2817f5bbf8202b50d93b6044d6595ea4b29b9a.camel@HansenPartnership.com>
Subject: Re: tpm2key.asn1 parent identification
From: James Bottomley <James.Bottomley@HansenPartnership.com>
To: Jarkko Sakkinen <jarkko@kernel.org>
Cc: linux-integrity@vger.kernel.org, tpm2@lists.linux.dev
Date: Tue, 16 Sep 2025 22:33:43 -0400
...
> > >=20
> > > It can, how?=C2=A0 If the parent is a primary, you can't insert it
...
you to please make the effort to tone down the hostile rhetoric.=20

Return-Path: <linux-integrity+bounces-6875-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 587C4B2BC35
	for <lists+linux-integrity@lfdr.de>; Tue, 19 Aug 2025 10:51:35 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 135415E082F
	for <lists+linux-integrity@lfdr.de>; Tue, 19 Aug 2025 08:51:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 548213115A9;
	Tue, 19 Aug 2025 08:51:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b="BX2W7Txi"
X-Original-To: linux-integrity@vger.kernel.org
Received: from lamorak.hansenpartnership.com (lamorak.hansenpartnership.com [198.37.111.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CBC69311C3D
	for <linux-integrity@vger.kernel.org>; Tue, 19 Aug 2025 08:51:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.37.111.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1755593492; cv=none; b=MR4iMTp5H0MBPXniPF4ijQ3l+sVN1B9g6ojfCNqhzOEYo7vsN57w7GWj7/OS8jweTDaoP2bsoi01lRH8HuZNtxXC9vL1UzptryM9y0Pl4rwzv+5d2Md5C9LAVs7IFehCoMmP4sui4bGQ/Y/jJY4voFgWv8DKsqKV7ozfdbLx368=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1755593492; c=relaxed/simple;
	bh=3dnBiFxjaZyIR1rQ/onML63cGD6hqcRcPQ3QtBKbPHI=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=SgQ49j4yR41jWKB+++8hdF/C2LwYirfrUhaA7Z6U7347cfbDjfysBXvQTZu+ExEuLoLZxgjCRgVGu4rlUokhOYbr+TsVXzyRaZXAhKkLseA6utS6pYiBg09zAeGMujLfWgn74/sDDZPiJWTPGkEU1vY1ROSKuIT1YNfLq9PT9eg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com; spf=pass smtp.mailfrom=HansenPartnership.com; dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b=BX2W7Txi; arc=none smtp.client-ip=198.37.111.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=HansenPartnership.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=hansenpartnership.com; s=20151216; t=1755593488;
	bh=3dnBiFxjaZyIR1rQ/onML63cGD6hqcRcPQ3QtBKbPHI=;
	h=Message-ID:Subject:From:To:Date:In-Reply-To:References:From;
	b=BX2W7TxihJ5iSJy/S7bddFjw/1kVXVfAWXtdqEK8zoDaOHfmZg6LLywJtXsOwGDZd
	 W703ez8IJGRBn4TgAGJh+a1hBMX5IUCaIfyfbIeHvk5X3cuo7bBh/D7+qFIj37X2gP
	 TcD3e8oDUm8i3ze6v2ctvzesyJJpgDdxD9mKSpl4=
Received: from [IPv6:2a00:23c8:101e:bb01:5bfe:95b6:ba99:a97b] (unknown [IPv6:2a00:23c8:101e:bb01:5bfe:95b6:ba99:a97b])
	...
	(No client certificate requested)
	by lamorak.hansenpartnership.com (Postfix) with ESMTPSA id 3053E1C0259;
	Tue, 19 Aug 2025 04:51:28 -0400 (EDT)
Message-ID: <517db659c835f0856daa7fa22cd4f22089111da3.camel@HansenPartnership.com>
Subject: Re: Questions about CONFIG_TCG_TPM2_HMAC
From: James Bottomley <James.Bottomley@HansenPartnership.com>
To: Chris Fenner <cfenn@google.com>
Cc: linux-integrity@vger.kernel.org
Date: Tue, 19 Aug 2025 09:51:26 +0100
In-Reply-To: <CAMigqh019OxTs+VaUjpEN3WoAkJnr1fJaciAELczgM9g1BMZUQ@mail.gmail.com>
References: 
	<CAMigqh2nwuRRxaLyOJ+QaTJ+XGmkQj=rMj5K9GP1bCcXp2OsBQ@mail.gmail.com>
	 ...
	 <CAMigqh019OxTs+VaUjpEN3WoAkJnr1fJaciAELczgM9g1BMZUQ@mail.gmail.com>

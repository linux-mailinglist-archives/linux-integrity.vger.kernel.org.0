...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 278B03C67A5
	for <lists+linux-integrity@lfdr.de>; Tue, 13 Jul 2021 02:49:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233765AbhGMAwD (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Mon, 12 Jul 2021 20:52:03 -0400
Received: from linux.microsoft.com ([13.77.154.182]:53380 "EHLO
        linux.microsoft.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233505AbhGMAwD (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.microsoft.com;
        ...
        bh=/ZYorAlJMpSjrJOR95U2DRoruJjrd6vyCyOjPFgLZb4=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=VV2yNGjBldjWZYlHcf3ooRr1BkcBRxPg7Ht2GLPbcrLL7Mw0YIuVafsI4vNWDJQVE
         iN6rAUeGrmzjZkyjFV+KB1yCPrb+dYy/+wN2XF/z5fyPC/Tcnnq6T+W773KyTPqOJm
         89mC8V9CO2PhHeMF/V+KDNMl9RXLI4iwO1/DPc+k=
From:   Tushar Sugandhi <tusharsu@linux.microsoft.com>
To:     dm-devel@redhat.com, agk@redhat.com, snitzer@redhat.com
Cc:     zohar@linux.ibm.com, linux-integrity@vger.kernel.org,
        nramas@linux.microsoft.com, tusharsu@linux.microsoft.com
Subject: [PATCH 6/7] dm: update target specific status functions to measure data

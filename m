Return-Path: <linux-integrity+bounces-4180-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id D37029D4E43
	for <lists+linux-integrity@lfdr.de>; Thu, 21 Nov 2024 15:05:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 650F31F22985
	for <lists+linux-integrity@lfdr.de>; Thu, 21 Nov 2024 14:05:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 585D51D86C7;
	Thu, 21 Nov 2024 14:05:20 +0000 (UTC)
...
Received: from smtp-bc09.mail.infomaniak.ch (smtp-bc09.mail.infomaniak.ch [45.157.188.9])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2A8D71CD3F
	for <linux-integrity@vger.kernel.org>; Thu, 21 Nov 2024 14:05:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.157.188.9
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1732197920; cv=none; b=APnY+I6JQVVr1p8OJSSIEeNYuqWSnj1GV49XNICRNDqHUcqYW8oa2ZOHPXpB78/jYJOB0FGv7jXXYJ4boqNZXieUCRl0+lgsd8V8JhkIjtXEuOltiNUlxlsMJrcKK6EUxoR+MdWrpQhzKkRJfJQI/4HUmNpOm/Hg5JL4i7OAXTc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1732197920; c=relaxed/simple;
	bh=xKDRpaLx7XAZXpE3qUdVTPQ9zSsrxc8OSS7TIptraDg=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=i2/DFl0/VWAexnDcxtHo/Qy9okzkwOfeaPFTWSe06oO9nd3gNvOXXOlNx2mOvfwO28imhO2nNzkLNSLtGxYdqGT3NoBJqOfE7k4kPjb5+WNqvqwAU6oWFkqNUYhVWWwWfkyOdHQuGRzOqz1OQFmoYHrSBiRV7oaWdxUwNdcbkYQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=digikod.net; spf=pass smtp.mailfrom=digikod.net; dkim=pass (1024-bit key) header.d=digikod.net header.i=@digikod.net header.b=P9hR0va0; arc=none smtp.client-ip=45.157.188.9

Return-Path: <linux-integrity+bounces-1873-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id B7FB888D8E7
	for <lists+linux-integrity@lfdr.de>; Wed, 27 Mar 2024 09:26:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 36C1C1F25337
	for <lists+linux-integrity@lfdr.de>; Wed, 27 Mar 2024 08:26:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3A0024779F;
...
Received: from mail-lj1-f169.google.com (mail-lj1-f169.google.com [209.85.208.169])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DC77338FA1
	for <linux-integrity@vger.kernel.org>; Wed, 27 Mar 2024 08:25:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.169
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711527924; cv=none; b=OJ66tdAKs47ub7Df2mtkJ7sS9fpBJbX6fS/99S8U957/SYewcQ3RGNk/tHVgH+/UTJjM8Ib8d7DxgBoAVrMFgfDHuMPiH8Rbm6OrC6ZFZNy1/CGNusI7UpaRdBdT4Y8AkRZtyKm2s5T5mtHDKl30gfbr8ZoAeVGxu7L6jTKb6Fs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711527924; c=relaxed/simple;
	bh=Xr7SHlqReVMUGU8MnJMNHJB/GT7lVWiG8UM22EKgLlw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=brUnIS0y5NvsqljcWpfhhj3njdgfaqCUkVdkUGeKuInhzhqtsQmSFoVbgOKcR5Mv5LNY5IBkGiGBTca+j2eciWAoaWM5fIQqgUEf0Ex0nYI+cjV3YI2stP8PM34pa4gCN7FvAAMJjxHlmtibvt7NJxn2KOR/dH1tnwF1Pnqx3DQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=sigma-star.at; spf=pass smtp.mailfrom=sigma-star.at; dkim=pass (2048-bit key) header.d=sigma-star.at header.i=@sigma-star.at header.b=A5BARKQg; arc=none smtp.client-ip=209.85.208.169
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=sigma-star.at
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sigma-star.at
Received: by mail-lj1-f169.google.com with SMTP id 38308e7fff4ca-2d6a1af9c07so87795831fa.3
        for <linux-integrity@vger.kernel.org>; Wed, 27 Mar 2024 01:25:20 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Jk3bunkUZB3eJdbTI0pWomxdZHb/buVMZM8Xz7Iwzes=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWh1Y3afNBS1TvtHobqhk+ki3T/ynZ3393kkjOumxapBHu7YNaCglMvnQYxu85wm5fQ7BQpGMVn/se0PLiWMkqwuvtpNEK5cFL/r1bCPgmo
X-Gm-Message-State: AOJu0YzM57FQF2dwzAO4tJHbTxaTCzZU3yT1WumtwyDM0zFOkW38QztL
	qB/PkjI+LdSJWcSCLtcHAXhO1ACo27WpC50+fkNa/Afb2Z6PzTMTQTFbsaKJd8g=

...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2E031228453
	for <lists+linux-integrity@lfdr.de>; Tue, 21 Jul 2020 17:56:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728462AbgGUP4j (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Tue, 21 Jul 2020 11:56:39 -0400
Received: from bedivere.hansenpartnership.com ([66.63.167.143]:35582 "EHLO
        bedivere.hansenpartnership.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726892AbgGUP4j (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Tue, 21 Jul 2020 11:56:39 -0400
Received: from localhost (localhost [127.0.0.1])
        by bedivere.hansenpartnership.com (Postfix) with ESMTP id DA95B8EE272;
        Tue, 21 Jul 2020 08:56:38 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=hansenpartnership.com;
        s=20151216; t=1595346998;
        bh=nKAHxFB/3ffnc9oeJyoqYLK7JZF6ZHh+PkmZjf4vbGQ=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=JIUmANVkg1YxYdNio74qCp3OFlE7tqbbSr9E44ULWUX4EOvnxepRLx9LQRKaQSsF8
         YDYhXX4DANMoz1P99eK7pkwiLQNpuEy3HZbJ0H2+RNnVzZG67MwrMJSEaL+HbRa+J0
         bSc9WinHP+6b+drVwl72pRlMjemsYr6SmFzNzqWo=
Received: from bedivere.hansenpartnership.com ([127.0.0.1])
        by localhost (bedivere.hansenpartnership.com [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id C1P7YwSHJnqp; Tue, 21 Jul 2020 08:56:38 -0700 (PDT)
Received: from jarvis.lan (jarvis.ext.hansenpartnership.com [153.66.160.226])
        by bedivere.hansenpartnership.com (Postfix) with ESMTP id 830838EE207;
        Tue, 21 Jul 2020 08:56:38 -0700 (PDT)
From:   James Bottomley <James.Bottomley@HansenPartnership.com>
To:     linux-integrity@vger.kernel.org
Cc:     Mimi Zohar <zohar@linux.ibm.com>,
        Jarkko Sakkinen <jarkko.sakkinen@linux.intel.com>
Subject: [PATCH v2 1/1] tpm: add sysfs exports for all banks of PCR registers
Date:   Tue, 21 Jul 2020 08:56:15 -0700
Message-Id: <20200721155615.12625-2-James.Bottomley@HansenPartnership.com>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20200721155615.12625-1-James.Bottomley@HansenPartnership.com>

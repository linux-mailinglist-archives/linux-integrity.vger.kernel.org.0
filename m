Return-Path: <linux-integrity+bounces-9644-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id maN3ExdIEWrmjQYAu9opvQ
	(envelope-from <linux-integrity+bounces-9644-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Sat, 23 May 2026 08:24:23 +0200
X-Original-To: lists+linux-integrity@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id B701D5BD6C8
	for <lists+linux-integrity@lfdr.de>; Sat, 23 May 2026 08:24:21 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id A51D43012CD1
	for <lists+linux-integrity@lfdr.de>; Sat, 23 May 2026 06:24:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 326F3318EE7;
	Sat, 23 May 2026 06:24:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=arm.com header.i=@arm.com header.b="tmDQ8GUn"
X-Original-To: linux-integrity@vger.kernel.org
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4DDA927466A;
	Sat, 23 May 2026 06:24:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.140.110.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1779517458; cv=none; b=Zh407KkKTMtPGzvK4sXsvsaoMqr66lLMOaDLj95j4kfU6vwsaAnpwPNoN2Exb6xSTg7RPWyJkHgIA0qyIrNQQD74QBUYa6tUeNkXfujI8Y/lGWFQXgyrMI6yVJ7mKPII3UBEt6zQpRcZ0wd9Ie8Gw/KNfjIiqaZy4ePzt0sSwfo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1779517458; c=relaxed/simple;
	bh=Ms5J6EUtWHbrYHbwQn2ZhbycP8n29DxzAdfpjTIcFqk=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=LrDzOJWzRnHQN2DHvd8v1Ud07UmARrb+IzW+ZdfFbKKlbcOeie8tV8RC8QCN+bDyPqdfsC4TB0zpxMrpI7huwu0OfuKFLoKDf4uZzVVShm0UqWMeDZ8nftPleE1KShSwl66ilViE7BblG4A2LHYNLYd7N6cGeEStRGbbWxgSMbQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com; spf=pass smtp.mailfrom=arm.com; dkim=pass (1024-bit key) header.d=arm.com header.i=@arm.com header.b=tmDQ8GUn; arc=none smtp.client-ip=217.140.110.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=arm.com
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
	by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 6AA931F02;
	Fri, 22 May 2026 23:23:58 -0700 (PDT)
Received: from e129823.arm.com (e129823.arm.com [10.1.197.6])
	by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 9F0743F7B4;
	Fri, 22 May 2026 23:24:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=arm.com; s=foss;
	t=1779517443; bh=Ms5J6EUtWHbrYHbwQn2ZhbycP8n29DxzAdfpjTIcFqk=;
	h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
	b=tmDQ8GUnoYV8a29MJBIMNVOT55qkJm1YtTiqiWlLbolJO3vaZMrlkUi8e4LWbhfXz
	 GypfuhRPl9gXAAzmwlwgiE65ulh566JZIO6uaSry58pkdkkWZVPLA3ODev4Hiwn8hE
	 Eene9jXRlToOe/UQUC58JUI5gv5WcG9At+iTFUB0=
Date: Sat, 23 May 2026 07:23:59 +0100
...
Message-ID: <ahFH/wi3UXGkfLbM@e129823.arm.com>
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-9644-lists,linux-integrity=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	MISSING_XM_UA(0.00)[];

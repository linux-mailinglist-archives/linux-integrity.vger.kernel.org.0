...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 74A9910BEFF
	for <lists+linux-integrity@lfdr.de>; Wed, 27 Nov 2019 22:40:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730076AbfK0VkF (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Wed, 27 Nov 2019 16:40:05 -0500
Received: from sonic311-51.consmr.mail.ne1.yahoo.com ([66.163.188.232]:45991
        "EHLO sonic311-51.consmr.mail.ne1.yahoo.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1730023AbfK0VkF (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Wed, 27 Nov 2019 16:40:05 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=yahoo.com; s=s2048; t=1574890803; bh=3Q+mUmikadEqWWUrYn8duO5ptf6RFtvCG2MjuW64iFE=; h=From:To:Subject:Date:In-Reply-To:References:From:Subject; b=
X-YMail-OSG: N_6BpMEVRDvd.miR6A7lED5GPdAEx7ojsA--
Received: from sonic.gate.mail.ne1.yahoo.com by sonic311.consmr.mail.ne1.yahoo.com with HTTP; Wed, 27 Nov 2019 21:40:03 +0000
Received: by smtp406.mail.bf1.yahoo.com (Oath Hermes SMTP Server) with ESMTPA ID 2c2d0f9121a87dc46718f3aa46e4610a;
          Wed, 27 Nov 2019 21:38:02 +0000 (UTC)
From:   Casey Schaufler <casey@schaufler-ca.com>
To:     linux-integrity@vger.kernel.org, zohar@linux.ibm.com
Subject: [v11-ima PATCH 14/25] LSM: Ensure the correct LSM context releaser
Date:   Wed, 27 Nov 2019 13:37:07 -0800
Message-Id: <20191127213718.18267-15-casey@schaufler-ca.com>
...
index 62a59c7284b0..2e72fc0ead2e 100644
--- a/drivers/android/binder.c
+++ b/drivers/android/binder.c
@@ -2867,6 +2867,7 @@ static void binder_transaction(struct binder_proc *proc,
...
index 11eafcfc490b..67f8e29747ca 100644
--- a/fs/nfs/nfs4proc.c
+++ b/fs/nfs/nfs4proc.c
...
index 6d6b60a02f22..1ba390cd2868 100644
--- a/include/linux/security.h
+++ b/include/linux/security.h
@@ -125,6 +125,41 @@ enum lockdown_reason {
...
+
  ...
  *
@@ -495,7 +530,7 @@ int security_ismaclabel(const char *name);
...
@@ -1309,7 +1344,7 @@ static inline int security_secctx_to_secid(const char *secdata,
 	return -EOPNOTSUPP;
 }

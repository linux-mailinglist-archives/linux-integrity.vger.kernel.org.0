Return-Path: <linux-integrity+bounces-8850-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OEKyKOzKpmk0TwAAu9opvQ
	(envelope-from <linux-integrity+bounces-8850-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Tue, 03 Mar 2026 12:50:04 +0100
X-Original-To: lists+linux-integrity@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 17EBA1EE8C1
	for <lists+linux-integrity@lfdr.de>; Tue, 03 Mar 2026 12:50:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 6E8E93327923
	for <lists+linux-integrity@lfdr.de>; Tue,  3 Mar 2026 11:39:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 37000481FD3;
	Tue,  3 Mar 2026 11:32:12 +0000 (UTC)
...
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 97E4348AE0A
	for <linux-integrity@vger.kernel.org>; Tue,  3 Mar 2026 11:31:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.135.223.131
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1772537531; cv=none; b=jllMaiZe8alorg4OaluS3AHHDJrf8EBuj4CW77mC2Pcpb8f+NVA8GiBHhQboxT8JTZ2KdCd+/9MxrYShfw3kEQCbgF6MIE3vm6uf3AsOMEZlGWk01e4UNSa2fLC0zLwjdMSs5GUX1QKzVJdsorqNaXJKgiCUQytbCs0vOiCgP9U=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1772537531; c=relaxed/simple;
	bh=ynqZIEdsmnksAp+Cm2jKyEanqimmQJ7OUe2VulEAlt4=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=mzxkpVJ5LeLIsltZgQ7qdW1/uQluGQm3RnN83rjGTL1s7eToLuQhjfctGj8I2CwacidhsQpTa28wBBW4ROHa8rx8jpc/VCBnt2XsXpPD1P66ER+7bASafWE6XgYZKOxZxUENt7SZreyzYhuZScX12hcqUV9vWsg6KaCQJusmEeQ=
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-8850-lists,linux-integrity=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[suse.cz:dkim,suse.cz:email,sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo,iloc.bh:url,suse.com:email,vaf.va:url];
 ...
 g];
	...
	FROM_NEQ_ENVFROM(0.00)[jack@suse.cz,linux-integrity@vger.kernel.org];
	FROM_HAS_DN(0.00)[];

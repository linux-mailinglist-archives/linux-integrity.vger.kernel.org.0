...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8059A407174
	for <lists+linux-integrity@lfdr.de>; Fri, 10 Sep 2021 20:47:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229476AbhIJSsa (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Fri, 10 Sep 2021 14:48:30 -0400
Received: from us-smtp-delivery-124.mimecast.com ([216.205.24.124]:22889 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S230260AbhIJSs3 (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Fri, 10 Sep 2021 14:48:29 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1631299638;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=DdlexkiBMfQvRGRGyKca4TqG+y1BP6buNKJeKC46s8g=;
        b=GVGGSoQ9P2vg9+iAmGd3/cjfCg7amRNbd7DpOGXKaQ5LPTH1I/+mQh2kGHTG5wgWKwwOoB
        sQm6ZSFiI5JRP5960DTA5XRhYF9emlBY2p7P6RVdoy9kMObpLypB3b3i17v4yh2/5EFrCm
        1OsSyWR41c0O1ks3MHyl1FU3qPovkf0=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-289-QWCV-mMmM-eBpShfhw1KAA-1; Fri, 10 Sep 2021 14:47:14 -0400
X-MC-Unique: QWCV-mMmM-eBpShfhw1KAA-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 92DED801A92;
        Fri, 10 Sep 2021 18:47:13 +0000 (UTC)
Received: from localhost (unknown [10.22.33.86])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 4E32119C79;
        Fri, 10 Sep 2021 18:47:10 +0000 (UTC)
From:   Bruno Meneguele <bmeneg@redhat.com>
To:     zohar@linux.ibm.com, Simon.THOBY@viveris.fr, kgold@linux.ibm.com
Cc:     linux-integrity@vger.kernel.org,
        Bruno Meneguele <bmeneg@redhat.com>
Subject: [PATCH v7 ima-evm-utils 1/2] set default hash algorithm in configuration time
Date:   Fri, 10 Sep 2021 15:47:00 -0300
Message-Id: <20210910184701.386163-2-bmeneg@redhat.com>
...
index 1cc027f6e0ba..15fc3bba24e0 100644
--- a/README
+++ b/README
@@ -41,7 +41,7 @@ COMMANDS
 OPTIONS
...
index 000000000000..b6164a57d11f
--- /dev/null
...
index 9d661d7f24a4..4d66610409ed 100644
--- a/src/evmctl.c
+++ b/src/evmctl.c
...
+		"  -a, --hashalgo     sha1, sha224, sha256, sha384, sha512, streebog256, streebog512 (default: %s)\n"
 		...
 		"  -d, --imahash      make IMA hash\n"
 		"  -f, --sigfile      store IMA signature in .sig file instead of xattr\n"
@@ -2537,7 +2537,7 @@ static void usage(void)
 		"\n"

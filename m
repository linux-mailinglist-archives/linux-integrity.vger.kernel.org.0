Return-Path: <linux-integrity+bounces-1871-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A1D688D8D7
	for <lists+linux-integrity@lfdr.de>; Wed, 27 Mar 2024 09:26:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1C1871F2B53E
	for <lists+linux-integrity@lfdr.de>; Wed, 27 Mar 2024 08:26:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ED66632C9C;
	Wed, 27 Mar 2024 08:25:18 +0000 (UTC)
...
Received: from mail-wm1-f43.google.com (mail-wm1-f43.google.com [209.85.128.43])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AC34638DFE
	for <linux-integrity@vger.kernel.org>; Wed, 27 Mar 2024 08:25:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.43
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711527918; cv=none; b=D4LAGMhudse+r+vkITfgfWpTPgZ2gSzE2SkL3fEi3s3BYeHFeuvUXGzxf40gDAzj6iOZqlMB1SR8ur7xN2BtnbprwJmG221d2d7p4Dj4K8JbfROf0nTRpjbKhueKUDTIKEoerWKY8aFmffdonSpAqKLukJU0V5DbgL047lb7HHM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711527918; c=relaxed/simple;
	bh=Pp+PWMknLeoCPLleVQShgDB1lm2/5LNqx4wH8PavKg8=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=BofyswbA/NwvSr/yMZIWc/ft2bdfbAnwx386zOusKCNHaplCG3/QHK8d+pYKbneTwE04BZ6zCG1VVQhy4BrHSe+kChuvAJt/YYiNwQnCVQQgecz2W2pxmO6YWgQpg6+Zb1HVVBCtquw0WsFIbNwt94d62T6EC6HixPtniv9EAdw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=sigma-star.at; spf=pass smtp.mailfrom=sigma-star.at; dkim=pass (2048-bit key) header.d=sigma-star.at header.i=@sigma-star.at header.b=ZdBiQHFO; arc=none smtp.client-ip=209.85.128.43
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=sigma-star.at
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sigma-star.at
Received: by mail-wm1-f43.google.com with SMTP id 5b1f17b1804b1-41493e21931so2875825e9.3
        for <linux-integrity@vger.kernel.org>; Wed, 27 Mar 2024 01:25:16 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=zIG2sL6TE413lQBd5tWYvh6NYan1WxgVQ6EtXfg8N2A=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVs1ovmbkm3znFEIdiTrojwLw8fpahBmQKLs7IFiTpLQGLD5Bf2YLCy+yiN8jaJwwl3yAPk+f4uURX/GKeMjEKN1dNjNtzYgFkjjWxmivNN
X-Gm-Message-State: AOJu0YwUaqtOb7VkO0J1sJVCl4/f80HoZk/0/nzpXn2hlyq+94CzbB/m
	zY4MvAk4XvQF1r3Qil+KTPWC7bAfwTRm1/3DdCwmggiQ3oUlwaYiMCnITzqq9bc=

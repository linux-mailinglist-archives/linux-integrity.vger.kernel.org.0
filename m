Return-Path: <linux-integrity+bounces-1093-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id EA86984D8B3
	for <lists+linux-integrity@lfdr.de>; Thu,  8 Feb 2024 04:23:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A62512870B3
	for <lists+linux-integrity@lfdr.de>; Thu,  8 Feb 2024 03:23:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 44773376EA;
...
Received: from mail-qv1-f41.google.com (mail-qv1-f41.google.com [209.85.219.41])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E8B9436113
	for <linux-integrity@vger.kernel.org>; Thu,  8 Feb 2024 03:18:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.41
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707362334; cv=none; b=LJZNoFk42GTRdT7F8c0Z5mCiX1PNYSf2FC9PKDhuBoeDh+6kVnFuhSs/1af7uHlIS5HCBBua8VcenjunJ3cPHUj8IaQK8CTpx10J03JiDwb3oqzgPcMQQgeR9iMJkWwXcJVr6AnzKovijoBT0m6GReS0TPUcXCf4rbV4IRNkUbE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707362334; c=relaxed/simple;
	bh=wNqqnpiWihipN1dNDa3R3CueTKA9HqfAdngEnTXkecM=;
	h=Date:Message-ID:MIME-Version:Content-Type:Content-Disposition:
	 From:To:Cc:Subject:References:In-Reply-To; b=qSHNnZX09yY8sQfeK/zSxFfV/UpOauBzm1GRUT7z3l+5EzaZUc0jn0SSvRuAieYotG5E18SExCu+e5GPZteI8pQi/Frvf6PuZKNnLDnZF4VuDmjAj3yWU+DIYKvkj11SFEFc2H5UV+njIumCOHIejC+j3aSWrd8PWHiOrsasghg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=paul-moore.com; spf=pass smtp.mailfrom=paul-moore.com; dkim=pass (2048-bit key) header.d=paul-moore.com header.i=@paul-moore.com header.b=DCrtUz4s; arc=none smtp.client-ip=209.85.219.41
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=paul-moore.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=paul-moore.com
Received: by mail-qv1-f41.google.com with SMTP id 6a1803df08f44-68ca3ab3358so7943366d6.2
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=UIu0ZaUnnX6YtAPfQYEsJ1lwfXBxkEp2fAdgZyQneCI=;
        b=
X-Gm-Message-State: AOJu0YwN7tBAbH4alhI9CoXri2JT3JHPReeKnnxJxZ6N1gIzTPLRK3eW
	6G+pCLxzi/VbHsrgm2JNljTSS9gQEGhLxt0/BpppPGCYOc2FiL8mMAFsVpMxVw==

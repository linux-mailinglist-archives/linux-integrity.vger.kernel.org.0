Return-Path: <linux-integrity+bounces-6210-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FBAFAB6D2C
	for <lists+linux-integrity@lfdr.de>; Wed, 14 May 2025 15:47:57 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id ED792189BCAB
	for <lists+linux-integrity@lfdr.de>; Wed, 14 May 2025 13:47:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A3CA218BC0C;
	Wed, 14 May 2025 13:46:50 +0000 (UTC)
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6D59527C172
	for <linux-integrity@vger.kernel.org>; Wed, 14 May 2025 13:46:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1747230410; cv=none; b=CVjvGfw/zXnrZjC+F+VANq483ySPxRb9lbMI5ICR5gmu6RHlTlxXlEIxzLf7pQSLaGQbIO0XisFf3RXXInXh8mo65QG+sXPAbUbZx1Vp+/R5dBh3+4fdwkEPMkTSMEjGrDDPoj25JZBNcrLQNxRRIEPcr7y971HcZuLpkmUl+uo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1747230410; c=relaxed/simple;
	bh=jbzwujdFwSka37fXOVWs7M2ikfwWiFepjMmj+dUeOB8=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=U9kK5hV5B2TkRyBa6aN0scJIMNWdZKZT51mXy9n+kUtR1wKnjS09BhBef2U76y6K+XX+H9BhP5cVJ0GgQHfu92qpaC0ZAG7NhfoE/w4z5z2nfrCbgOPcPUhinu2Yk92V4T9YhA2slVHmITxPydlEnzt9GsembCEx/pwhzNV1zBQ=
...
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 ...
 us-mta-398-hQ1VaDoeOL-qnP4Aju4yPQ-1; Wed, 14 May 2025 09:46:46 -0400
X-MC-Unique: hQ1VaDoeOL-qnP4Aju4yPQ-1
X-Mimecast-MFC-AGG-ID: hQ1VaDoeOL-qnP4Aju4yPQ_1747230405
Received: by mail-wr1-f71.google.com with SMTP id ffacd0b85a97d-3a0bcaf5f45so2303975f8f.1
        for <linux-integrity@vger.kernel.org>; Wed, 14 May 2025 06:46:46 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=In0iCep6742EFTxP/bkOpZWh7Qqg86OA5FVVLbMh2YI=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUNxp2BICu6xhfyNs+jp8wrhVDxH+MejKZuNy9j7/OajMoo55DhlLUn1UJ5tfGyO8DR+Y3C7d7xI0atSbL8/n4=@vger.kernel.org
X-Gm-Message-State: AOJu0YzXRTMYuoByD7LDjM2snpDrYD18FhbxTF+PhqvDb+VGlD/9UoW8
	6hycsbxsMOWHElEDCMrhY/TTLO8Fv8HXTTEhk8ttAF6u5LygUz7WMhA6VJJ/5UoYUr/wF4G/b4b
	8nP3Pm4sD+3hkNOamWODlolIoskNLxgflgGJCCAlvVusV+nhhOxH+fohzHEgpIxzJQQ==
X-Gm-Gg: 
X-Received: by 2002:a05:6000:40dc:b0:3a0:bcb0:f69c with SMTP id ffacd0b85a97d-3a34969ac5amr3037621f8f.3.1747230405011;

Return-Path: <linux-integrity+bounces-2306-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id E085A8BB705
	for <lists+linux-integrity@lfdr.de>; Sat,  4 May 2024 00:17:44 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 0FB751C248C2
	for <lists+linux-integrity@lfdr.de>; Fri,  3 May 2024 22:17:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0251D5C614;
	Fri,  3 May 2024 22:17:13 +0000 (UTC)
...
Received: from mail-lj1-f169.google.com (mail-lj1-f169.google.com [209.85.208.169])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B844A824AB
	for <linux-integrity@vger.kernel.org>; Fri,  3 May 2024 22:17:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.169
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714774632; cv=none; b=PgRB/daBBDdF/zsJp6QT+ZhRuN3pYz9f9hAzuX75ijWI4WSMvUqtvp0XTUJeXoDihminNnYeTm7V1dKqcY/6F6rzp7BltnBNSvd8a3LnT146yj9gZGiHu6heLtR66WONk4lD4Sv6tLwFYu67XW2pkpSywfL51/W69IwfKYV2nXA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714774632; c=relaxed/simple;
	bh=UN9euo6tmA4lZN0yrzzT/2yT1Q5aGhR2qOSjFmblmcE=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=aW3It1WMTlQQW/HGdETYGAZGvkwmO4LIBVNQcGsFDmvXu+IynW2RhO3RiMl0E3CIEYVxtevw+8mFMwlkR2E9xUSYsfGQ1vA22pc7JDHwgg6JMiPi5CT8MVh8uvQXRJ2vAodkn5EKjm9/OVL8yPsfz5EWFzy/ovcuwVbirWFNVX8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=cloudflare.com; spf=pass smtp.mailfrom=cloudflare.com; dkim=pass (2048-bit key) header.d=cloudflare.com header.i=@cloudflare.com header.b=LCQNZO3H; arc=none smtp.client-ip=209.85.208.169
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=cloudflare.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=cloudflare.com
Received: by mail-lj1-f169.google.com with SMTP id 38308e7fff4ca-2dfb4ea2bbfso1712531fa.2
        for <linux-integrity@vger.kernel.org>; Fri, 03 May 2024 15:17:10 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xYgJucBWcBFFpUyC+MXvUnpM2o5I+5vueQelq0cH798=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWkEBuqo3ui1TF4mqQKe9chrYZN9XX9Ycadrg06o80EZHlCJHdcjH1zc7n7I9HIUO/oQkTzFoIh4Xi4qMTyBEG7UgBsVfLYqe1U9d0wwBWv
X-Gm-Message-State: AOJu0Yw+5XvwIEuOh33KmqKvd1G0ZWZfM868o5g+/gJ9qmy76+T5MYTm
	CttdKJX+jzvd+0akbsZIHTHQJUFbbRGEnvyDGCIQ01O9RRiQRlta4p2roR+xRRg=

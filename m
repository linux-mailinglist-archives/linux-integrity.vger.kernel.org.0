Return-Path: <linux-integrity+bounces-2778-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E6C48FADA6
	for <lists+linux-integrity@lfdr.de>; Tue,  4 Jun 2024 10:29:45 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 3F8212815BF
	for <lists+linux-integrity@lfdr.de>; Tue,  4 Jun 2024 08:29:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 37271142640;
	Tue,  4 Jun 2024 08:29:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="PIvExF7K"
X-Original-To: linux-integrity@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 902911422DD
	for <linux-integrity@vger.kernel.org>; Tue,  4 Jun 2024 08:29:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1717489755; cv=none; b=WC7+YKAyckh8GCZFrmTkDsQnrMcITc+8+hR2FWIpCbsNch0Q4JGtUo6DmAnNVUArNxydqQeieUBrRGYWnwkIxMgvsS1wmW+EtiKXf4x4WsLvh5u4LVC9izOlKX6rM1I0RljkPQ+4fxnCU+KzCyJbwXg1tbL988xLQmX0udn1Ccg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1717489755; c=relaxed/simple;
	bh=rzHBFBjrOD1LpzwYSLdt1evD+GdcoxpcN2M/rIgqwjM=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=IoBPHZJB5RD6G51M+DdwGiOeNW6k2lAQqwpV0b7NeuZ8VVeWRmNUDuO8/g8bPZJN8NTmnidOiYqNn5v9GYs3rFUwuWB7McEa+UKGxhIAStG3URs5gtDWuKjjMbErztDDyKBWy0yDKus20Sb5XaLslTlRfYMBKvTMjTdaQumcoqE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=PIvExF7K; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1717489750;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=uRxb4s91be8Z5K0PlcwW7xp4HZ8oD+zUX1ejruZ7C98=;
	b=PIvExF7KQaGkYdlhT6JRo9JJI6LGbSQ2X37HeOS3G4zdKykWU9IR8Boy/ZJWwWwB2v4Nh3
	m+SBShm1eq+y00TDH4rwzE5wD5QAUpuRXdMGgu8T5ajPpzK70TIXSHjrByYnv2+mDdQdbR
	4z3r3tw/AU5OB3S3YdlftSqqAYh+ygM=
Received: from mail-lj1-f200.google.com (mail-lj1-f200.google.com
 [209.85.208.200]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-599-YhbDZ2HfMjOWiQp7_hr5NQ-1; Tue, 04 Jun 2024 04:29:08 -0400
X-MC-Unique: YhbDZ2HfMjOWiQp7_hr5NQ-1
Received: by mail-lj1-f200.google.com with SMTP id 38308e7fff4ca-2e95a73c99eso44905381fa.2
        for <linux-integrity@vger.kernel.org>; Tue, 04 Jun 2024 01:29:08 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=uRxb4s91be8Z5K0PlcwW7xp4HZ8oD+zUX1ejruZ7C98=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVNmxrQXTmkUF8fSUaLuSGsHk6N3OdAMqp7Nnj3+eZZflsR6G9LFJNzmzkHwviKoa4WHaPygGdrJKcnbFel/goL91ksLVE1vfBnHAkHjUT+
X-Gm-Message-State: AOJu0YyqYpNU/Oz+GnGMh52bNVHJAufEnSDrD1xCMDo7XTBBRRnG0S+D
	nLCqNk39SmImk75CMHSmGtKhRtp3d1T+9SbtlTHbWI7kDWAATpx9Aifb5qjTXF2o28616y3okRM
	wIIycxUUtYjVCoWGgmIKF1LuO6HPNPcrybDGzKpnMsMbFFFpPDAsYYwSK39Bzqx2QkqlbhLq5u2
	17
X-Received: by 2002:a2e:b693:0:b0:2e9:8852:3d20 with SMTP id 38308e7fff4ca-2ea951e4c52mr90428961fa.41.1717489746497;

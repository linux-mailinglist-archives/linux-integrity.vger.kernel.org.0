...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D42DF229C7A
	for <lists+linux-integrity@lfdr.de>; Wed, 22 Jul 2020 18:01:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726427AbgGVQBb (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Wed, 22 Jul 2020 12:01:31 -0400
Received: from bedivere.hansenpartnership.com ([66.63.167.143]:51296 "EHLO
        bedivere.hansenpartnership.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726349AbgGVQBb (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Wed, 22 Jul 2020 12:01:31 -0400
Received: from localhost (localhost [127.0.0.1])
        by bedivere.hansenpartnership.com (Postfix) with ESMTP id EC91B8EE272;
        Wed, 22 Jul 2020 09:01:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=hansenpartnership.com;
        s=20151216; t=1595433691;
        bh=PvWLz54ci5wO2fRgUh1fILGYVYiCvIwHnSiMdUfr+NE=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=r5oUI5C6n57Uc9uwnywXaP63zXaTR2iAOoS4Q2pH6pvzjoY2M4OAePCF5GK3PFzp6
         +yZTOI4zJ0Jo+HvyVtqI8wfzR6wVUvd7pAQxAs8m25iODIGe0a+VpbuXiPFNFQhmTd
         PVhMIeNU45LuqJlT9nxVDl6rnBOEtRiNs+nzjAXE=
Received: from bedivere.hansenpartnership.com ([127.0.0.1])
        by localhost (bedivere.hansenpartnership.com [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 7j3j1m36S1UT; Wed, 22 Jul 2020 09:01:30 -0700 (PDT)
Received: from jarvis.lan (jarvis.ext.hansenpartnership.com [153.66.160.226])
        by bedivere.hansenpartnership.com (Postfix) with ESMTP id 113498EE200;
        Wed, 22 Jul 2020 09:01:29 -0700 (PDT)
From:   James Bottomley <James.Bottomley@HansenPartnership.com>
To:     linux-integrity@vger.kernel.org
Cc:     Mimi Zohar <zohar@linux.ibm.com>,
        Jarkko Sakkinen <jarkko.sakkinen@linux.intel.com>
Subject: [PATCH v3 1/1] tpm: add sysfs exports for all banks of PCR registers
Date:   Wed, 22 Jul 2020 08:57:39 -0700
Message-Id: <20200722155739.26957-2-James.Bottomley@HansenPartnership.com>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20200722155739.26957-1-James.Bottomley@HansenPartnership.com>

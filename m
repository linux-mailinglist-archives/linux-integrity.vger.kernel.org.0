...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E633F83D31
	for <lists+linux-integrity@lfdr.de>; Wed,  7 Aug 2019 00:08:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727256AbfHFWIF (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Tue, 6 Aug 2019 18:08:05 -0400
Received: from mail-pg1-f193.google.com ([209.85.215.193]:37739 "EHLO
        mail-pg1-f193.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727266AbfHFWH4 (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Tue, 6 Aug 2019 18:07:56 -0400
Received: by mail-pg1-f193.google.com with SMTP id d1so9489098pgp.4
        for <linux-integrity@vger.kernel.org>; Tue, 06 Aug 2019 15:07:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=aGB1JOcWkNrmNIrAbUIMMZPjec4nmi/ieC7f+At+HTU=;
        b=M/DuXrEJUhbdTn1c+LtqQZn1WnnZHDGk5OY3MapcY5dR4k6PX4YAXOYyKQTCfHDiX7
         E/DxWSQYug+lXCugjXbMvsVBCG6mNGmXQW5pQfTHNS7HOAVnSTXwLnOIDcSXZF0JWsHY
         l9aHZEZv+9W+ixqTniHebSDnTStcHMmEsLa3E=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=aGB1JOcWkNrmNIrAbUIMMZPjec4nmi/ieC7f+At+HTU=;
        b=
X-Gm-Message-State: APjAAAX3/SxW9n9tMDE/x8/eXA7WpPiCpieu21755r2pbIocHffGbrgx
        vYAJNM7eHBcNeKO2j5ZkuLQfSg==
X-Google-Smtp-Source: APXvYqy83kbS/+V5roUjMiIEaL/Ww+Z1+7rd67r8HAW2r9cehVOmk0XZjI4ZeCPLVdXv9yPnV4PT0A==
X-Received: by 2002:a62:750c:: with SMTP id q12mr6114316pfc.59.1565129275552;
        Tue, 06 Aug 2019 15:07:55 -0700 (PDT)
Received: from smtp.gmail.com ([2620:15c:202:1:fa53:7765:582b:82b9])
        by smtp.gmail.com with ESMTPSA id p7sm98982509pfp.131.2019.08.06.15.07.54
...
Subject: [PATCH v3 4/4] tpm: add driver for cr50 on SPI
Date:   Tue,  6 Aug 2019 15:07:50 -0700
Message-Id: <20190806220750.86597-5-swboyd@chromium.org>
...
index 000000000000..c65ac16d22b6
--- /dev/null

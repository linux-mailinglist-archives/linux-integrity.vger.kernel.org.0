Return-Path: <linux-integrity+bounces-8925-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id MGlDCnBVqWli5gAAu9opvQ
	(envelope-from <linux-integrity+bounces-8925-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Thu, 05 Mar 2026 11:05:36 +0100
X-Original-To: lists+linux-integrity@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B91620F540
	for <lists+linux-integrity@lfdr.de>; Thu, 05 Mar 2026 11:05:35 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id A5F793149270
	for <lists+linux-integrity@lfdr.de>; Thu,  5 Mar 2026 09:58:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 73E3829B233;
...
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.223.130])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CE48B37B3EC
	for <linux-integrity@vger.kernel.org>; Thu,  5 Mar 2026 09:58:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.135.223.130
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1772704729; cv=none; b=ceJtF0ZvgcNGKbMjJWwZbl8rs4YiC7dBb+jozdDMdL4btoRFRfocQ2H+jX4NSBrezINU//PzoZ3ayiReX/hW2+OozzeIVPN6ezwbRduoMlNbXcw00jNpMiFHQ1apV2hy3PTiffRw0dvhBpiOOmZtIY3UPpdcMu0Cm+XavlB9zyg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1772704729; c=relaxed/simple;
	bh=iIlB1mirXsO0NzWSB6uBFFiaReps4+oedtealSrty/o=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=HixcvdsWy35w3PeXTJ3jEyL8pVSL1lz0qnlsi602e8GI+20caIPR+owc/vJLa0fTAStiNQO4iBBbNmVqx8e6QgWbTUlGDdUXg9EHXFZi8rCJxdwZISv1c9nJ39133hcu+lkhvhVl2ViKpT/DedmrGyTCv9iGGr1/kv9G2A7ldH0=
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-8925-lists,linux-integrity=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[suse.cz:dkim,suse.cz:email,iloc.bh:url,sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo,str.name:url,vaf.va:url,suse.com:email];

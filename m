Return-Path: <linux-integrity+bounces-5865-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E715A88684
	for <lists+linux-integrity@lfdr.de>; Mon, 14 Apr 2025 17:10:37 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 35E4019073E1
	for <lists+linux-integrity@lfdr.de>; Mon, 14 Apr 2025 14:57:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1CAE8DF59;
	Mon, 14 Apr 2025 14:57:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="GeEPGDaP"
X-Original-To: linux-integrity@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EF31223D2B9
	for <linux-integrity@vger.kernel.org>; Mon, 14 Apr 2025 14:57:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1744642635; cv=none; b=RY/azCK6MwSV4YGi0CDcu8l8jvanqwP1HkMHgXQ6sRg1K9QfPeaGpDGOI3bzIRBWcWNBJObb0oqU67L/h5aMS+rusVb4vidncgdSUWoPkk9GTuq8dHZQqsKmMPRKPZjm3YHc30hQM2EweT84yFXRFQDZK1R6rCqcXvXfnOtDv3U=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1744642635; c=relaxed/simple;
	bh=aZz9h0cA1foktJYk9upYm5zNFFgLeE8xhPyaw8GEcb8=;
	h=From:To:Cc:Subject:Date:Message-ID:Content-Type:MIME-Version; b=cm8nRur04QAbldL/AcvtbSFKatFoxnBjZ7TqzJlFSnLCxCqVxh5S8QYkpchjw0ejMMJJm68mbaJ14He/YiSO8t3BqZnECkPqLiEPrveAs7sY0UCG5RdrArN6cAgwFYepTMa99BC87zgfGwzyYzo/8FyvZmGiUa89/Wx8uBx3z70=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=GeEPGDaP; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1744642630;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding;
	bh=+d+A9xPnDumItxIsvftLFslaA2BjML5aFFEu1+C33ys=;
	b=GeEPGDaPLBR0xleNlWPE4O4h0+IGv3fDWdmUqB+6P19T5qnRtYuU8OWZcXI3TnPXsGNYZo
	brGk3sbyIAlE0d8k0FZq3dUuAuzIC1VGKdPG7OAmhA+K45dmfUw9VKBQGN3utFI8LFaeeG
	QtVFznDK46Pk+3EHL6gHqRlR3j+IAdw=
Received: from mail-wm1-f72.google.com (mail-wm1-f72.google.com
 [209.85.128.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-145-xQ3wUTNzNeav6t7tV9si5g-1; Mon, 14 Apr 2025 10:57:09 -0400
X-MC-Unique: xQ3wUTNzNeav6t7tV9si5g-1
X-Mimecast-MFC-AGG-ID: xQ3wUTNzNeav6t7tV9si5g_1744642628
Received: by mail-wm1-f72.google.com with SMTP id 5b1f17b1804b1-43d01024089so37005885e9.1
        for <linux-integrity@vger.kernel.org>; Mon, 14 Apr 2025 07:57:09 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=+d+A9xPnDumItxIsvftLFslaA2BjML5aFFEu1+C33ys=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVtjW3GqtowW6eMTD1+F1Hx7YCoHlmTF6gmB0TMzWdV3IKmCyrYRSgf58yny/dfqq1S8XLIeZPQf18xSRE04qI=@vger.kernel.org
X-Gm-Message-State: AOJu0Ywu8AbohVh0tsKEngz0iKx12DIGgSvk4kgZLLGtB48K5w2kJ8ke
	UXyom+d4xb/AZhJNQ1khrl/a+hT1brptJ20vZq1yly7jSx1JOPj8e0i2AhAcnjFphgz3PUymiKr
	1MIU1hI2wnKIiIfpwqyqWBgI3oNlsct8fv6M4iOmuPoau1C8Rv/L/SQKVtfnxgZSNkw==
X-Gm-Gg: 
	hRuqad8V3KxDA7FupCqaSTUy
X-Received: by 2002:a05:600c:22c2:b0:43d:fa59:be39 with SMTP id 5b1f17b1804b1-43f3b03d509mr76635635e9.33.1744642624626;

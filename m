Return-Path: <linux-integrity+bounces-8830-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gLPnNC2ypmn9SgAAu9opvQ
	(envelope-from <linux-integrity+bounces-8830-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Tue, 03 Mar 2026 11:04:29 +0100
X-Original-To: lists+linux-integrity@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FDB61EC4A1
	for <lists+linux-integrity@lfdr.de>; Tue, 03 Mar 2026 11:04:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id CFD40307246D
	for <lists+linux-integrity@lfdr.de>; Tue,  3 Mar 2026 10:04:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 826FC369204;
	Tue,  3 Mar 2026 10:03:59 +0000 (UTC)
X-Original-To: linux-integrity@vger.kernel.org
Received: from metis.whiteo.stw.pengutronix.de (metis.whiteo.stw.pengutronix.de [185.203.201.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1793E38F646
	for <linux-integrity@vger.kernel.org>; Tue,  3 Mar 2026 10:03:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=185.203.201.7
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1772532239; cv=none; b=i/Hf5KCcGoFyAb1GeNItsrK6r9bGjPssYKvi3FHr8J3gVoZPYKw4HXBux9uoX7SUR6SJGHe0Nl/q55tuwmo+febgSJBOX62+ovUkl99mG136hDLsyJVxXnnza5I7IgD9N3edKMUDEQutgG23GjxE1EC6EOo/YSHV1eKvPm4x+w4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1772532239; c=relaxed/simple;
	bh=KGFR6GPIehO6zIdn2CFtuE4synSr/5rzwVcLZPCowm8=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=HIxk/CgyyfApoFriw/eg9ofOkHyjOwdk0Xjf89zZONdBEIUGNSmFT+gJGNCEvl8KJfmfvMcJaYPMULXE1Tu/sWpWStZJ6f/LRJQhLwaWCuQxFrkcIfgxNbpZWUgQmrjXkuPlAqR/Vc15zbPpG8gEJOIopc6mSJCSDqieTvJZmnQ=
...
X-Spamd-Result: default: False [-1.06 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-8830-lists,linux-integrity=lfdr.de];
	FROM_HAS_DN(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	...
	FROM_NEQ_ENVFROM(0.00)[mkl@pengutronix.de,linux-integrity@vger.kernel.org];

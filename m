Return-Path: <linux-integrity+bounces-9662-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CEKRC89SFGopMgcAu9opvQ
	(envelope-from <linux-integrity+bounces-9662-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Mon, 25 May 2026 15:46:55 +0200
X-Original-To: lists+linux-integrity@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 9EF135CB585
	for <lists+linux-integrity@lfdr.de>; Mon, 25 May 2026 15:46:54 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 96B7C3005172
	for <lists+linux-integrity@lfdr.de>; Mon, 25 May 2026 13:46:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 94F5833D4EE;
	Mon, 25 May 2026 13:46:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ibm.com header.i=@ibm.com header.b="kL1cDR2Z"
X-Original-To: linux-integrity@vger.kernel.org
Received: from mx0b-001b2d01.pphosted.com (mx0b-001b2d01.pphosted.com [148.163.158.5])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B9F207262E;
	Mon, 25 May 2026 13:46:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=148.163.158.5
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1779716810; cv=none; b=bxvjSqbRbq4RDskbx9FZdCnLir3gJuw57RH0hQzx6RhRNQrQPTQ4n64O8mu8Z9s+x5D9/NXTqwtSdRM1tHbc6czomtg6P+P5zzvGXdw2YpIBPAodirOAdrcn/apmYhVX9Is8i2oE7Y5t3PgkQwc4nbj0PP5oKgB6tea44hYv+Ss=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1779716810; c=relaxed/simple;
	bh=PnJTezh5zO+OvZ4To8m3c+NhilkVQBj6XrhM6Tt2i20=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=BGgDZWL4naJWKECE08s2hKyTNgEPa5tGV9RzkzYZ4rwIILBM0S/xyQjsenxlFYibbO4qxvCw5CJPnlZa6NJyd4D8D8IXOdKIMJWDxW1yj7BavZ+J4u3MsVU1+WF7FibbY0A8wT4VlLOWwIkobqCtmYIs/y93o8g7MDCwhbrAPIk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.ibm.com; spf=pass smtp.mailfrom=linux.ibm.com; dkim=pass (2048-bit key) header.d=ibm.com header.i=@ibm.com header.b=kL1cDR2Z; arc=none smtp.client-ip=148.163.158.5
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.ibm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linux.ibm.com
Received: from pps.filterd (m0356516.ppops.net [127.0.0.1])
	by mx0a-001b2d01.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id 64P0Kdx23938475;
	Mon, 25 May 2026 13:46:28 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=cc
	:content-transfer-encoding:content-type:date:from:in-reply-to
	:message-id:mime-version:references:subject:to; s=pp1; bh=8EkXer
	xx88m1L7A1U9u1dFS9Z810zeI20H5uALvieEQ=; b=kL1cDR2ZTasDxRUMc82z7X
	
	==
Received: from ppma13.dal12v.mail.ibm.com (dd.9e.1632.ip4.static.sl-reverse.com [50.22.158.221])
	by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 4eb4npy8j0-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Mon, 25 May 2026 13:46:27 +0000 (GMT)
Received: from pps.filterd (ppma13.dal12v.mail.ibm.com [127.0.0.1])
	by ppma13.dal12v.mail.ibm.com (8.18.1.7/8.18.1.7) with ESMTP id 64PDdTjk018616;
	Mon, 25 May 2026 13:46:26 GMT
Received: from smtprelay04.dal12v.mail.ibm.com ([172.16.1.6])
	by ppma13.dal12v.mail.ibm.com (PPS) with ESMTPS id 4ebrsg54xu-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Mon, 25 May 2026 13:46:26 +0000 (GMT)
Received: from smtpav04.wdc07v.mail.ibm.com (smtpav04.wdc07v.mail.ibm.com [10.39.53.231])
	by smtprelay04.dal12v.mail.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 64PDkPKS39190892
	(version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
	Mon, 25 May 2026 13:46:25 GMT
Received: from smtpav04.wdc07v.mail.ibm.com (unknown [127.0.0.1])
	by IMSVA (Postfix) with ESMTP id D9CF658050;
	Mon, 25 May 2026 13:46:24 +0000 (GMT)
Received: from smtpav04.wdc07v.mail.ibm.com (unknown [127.0.0.1])
	by IMSVA (Postfix) with ESMTP id 769E158054;
	Mon, 25 May 2026 13:46:05 +0000 (GMT)
Received: from [9.124.217.36] (unknown [9.124.217.36])
	by smtpav04.wdc07v.mail.ibm.com (Postfix) with ESMTP;
	Mon, 25 May 2026 13:46:05 +0000 (GMT)
Message-ID: <b4e26e4c-d62d-4551-bbdd-b4409316c4a9@linux.ibm.com>
Date: Mon, 25 May 2026 19:16:03 +0530
Precedence: bulk
...
X-Proofpoint-GUID: RZ2mliCufDvMhHrfYtGXphQg3223Fnkq
X-Proofpoint-ORIG-GUID: hi0yckgG5Z0DJLzf9MlFt0zXoVVCjnUZ
X-Authority-Analysis: v=2.4 cv=QIJYgALL c=1 sm=1 tr=0 ts=6a1452b3 cx=c_pps
 a=AfN7/Ok6k8XGzOShvHwTGQ==:117 a=AfN7/Ok6k8XGzOShvHwTGQ==:17
 a=IkcTkHD0fZMA:10 a=NGcC8JguVDcA:10 a=VkNPw1HP01LnGYTKEx00:22
 a=RnoormkPH1_aCDwRdu11:22 a=Y2IxJ9c9Rs8Kov3niI8_:22 a=VnNF1IyMAAAA:8
 a=rMIA4TsMAAAA:8 a=20KFwNOVAAAA:8 a=UN5060LkAAAA:8 a=yPCof4ZbAAAA:8
 a=pGLkceISAAAA:8 a=ychZsNU-MK1tARJ_zG0A:9 a=3ZKOabzyN94A:10 a=QEXdDO2ut3YA:10
 a=hVBJ2aql8SDTymIzffKL:22 a=E6eXv-vVeS7VqOnxGRGn:22
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjYwNTI1MDE0MCBTYWx0ZWRfX6uHTH3ELczG1
 
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-9662-lists,linux-integrity=lfdr.de];
	FREEMAIL_CC(0.00)[opinsys.com,redhat.com,apertussolutions.com,oracle.com,gmail.com,linux.ibm.com,gmx.de,ziepe.ca,HansenPartnership.com,paul-moore.com,namei.org,hallyn.com,vger.kernel.org];
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[apertussolutions.com:email,buf.data:url,linux.ibm.com:mid,oracle.com:email,tor.lore.kernel.org:rdns,tor.lore.kernel.org:helo];

Return-Path: <linux-integrity+bounces-7240-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D22A2B9656D
	for <lists+linux-integrity@lfdr.de>; Tue, 23 Sep 2025 16:41:51 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 0F7C53B178A
	for <lists+linux-integrity@lfdr.de>; Tue, 23 Sep 2025 14:37:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3064B233722;
	Tue, 23 Sep 2025 14:37:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b="DWGxBXm9"
X-Original-To: linux-integrity@vger.kernel.org
Received: from lamorak.hansenpartnership.com (lamorak.hansenpartnership.com [198.37.111.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5345D199FAB
	for <linux-integrity@vger.kernel.org>; Tue, 23 Sep 2025 14:37:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.37.111.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1758638230; cv=none; b=XSechUZH3Ms++RoQDVrIhtaxCPZpyygFVOzQ8tl8ZxuFtEq20JT9cUB4XuSPxYfOLiYtrvc5bETc0j5y0SgDMlSwxWccHQb/73qMxKdRd8XfsTpWe+HAmt+InJs2Y/6gBO6PNdvYVLOVGQNd2VPBn4ImMlJZc0X50qSNd3jVXFg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1758638230; c=relaxed/simple;
	bh=fXVUztmcUAcPhBflhvqkglS4Oh+LPW+RUl0lnxnZOFY=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=Y0GTBp4/8S2/3hlJ5FQSjlhNrutK8FbHyHVVhZXFSwF/Ey2/AhyPJzLaugKFJ588Gg5p3AR2QLdoXH5C4zovI4QP3HUcTS358ckZmdthuwBO0CwD5yKovMFoJiTaCZAMH7+80reh5MAlfai0NESgXV/5+Jchlq2/m2R8Of0py5c=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com; spf=pass smtp.mailfrom=HansenPartnership.com; dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b=DWGxBXm9; arc=none smtp.client-ip=198.37.111.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=HansenPartnership.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=hansenpartnership.com; s=20151216; t=1758638227;
	bh=fXVUztmcUAcPhBflhvqkglS4Oh+LPW+RUl0lnxnZOFY=;
	h=Message-ID:Subject:From:To:Date:In-Reply-To:References:From;
	b=DWGxBXm9o8+9BK0Jowvcyml7SjTMgeaNpC71twDOGnqDtyuFLQssQcQJ/aOqV4Qpa
	 JZnr2sORlpKowT91SKmXOMsNDWAY6xxVW7YMS/8W7L9N/267E0GFtsYLEJ0t70/aiB
	 tfvRoyn4IVhlWNIHcYHbHmHXOOR5z7+nAHhjbLqs=
Received: from lingrow.int.hansenpartnership.com (unknown [IPv6:2601:5c4:4302:c21::a774])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lamorak.hansenpartnership.com (Postfix) with ESMTPSA id 3A2A71C02EB;
	Tue, 23 Sep 2025 10:37:07 -0400 (EDT)
Message-ID: <d84351697f65dc3ab58d7c1634d129dee431074d.camel@HansenPartnership.com>
Subject: Re: tpm2key.asn1 parent identification
From: James Bottomley <James.Bottomley@HansenPartnership.com>
To: Jarkko Sakkinen <jarkko@kernel.org>
Cc: linux-integrity@vger.kernel.org, tpm2@lists.linux.dev
Date: Tue, 23 Sep 2025 10:37:06 -0400
In-Reply-To: <aNKt6kjNnFvhgRW1@kernel.org>
...
> > > > sustainable choice.
> > > >=20
> > > > Being able to fix key into cryptographic=C2=A0 identity is somewhat
...
> > > good reasons to disregard transient keys.=20
> >=20
...
> > > plain and simple.
> >=20
> > This contains no actionable technical content.=C2=A0 However, it is
...
https://groups.io/g/openssl-tpm2-engine/topic/patch_doc_update_draft_rfc/11=
5384542

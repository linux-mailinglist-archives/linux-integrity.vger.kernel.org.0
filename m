Return-Path: <linux-integrity+bounces-9643-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id IDkLHhQ2EWpeiwYAu9opvQ
	(envelope-from <linux-integrity+bounces-9643-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Sat, 23 May 2026 07:07:32 +0200
X-Original-To: lists+linux-integrity@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 260275BD310
	for <lists+linux-integrity@lfdr.de>; Sat, 23 May 2026 07:07:31 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id DB1DB30057A5
	for <lists+linux-integrity@lfdr.de>; Sat, 23 May 2026 05:06:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E3EB5233941;
	Sat, 23 May 2026 05:06:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="Fo6BA2Ut"
X-Original-To: linux-integrity@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-alma10-1.taild15c8.ts.net [100.103.45.18])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8457B313E1B;
	Sat, 23 May 2026 05:06:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=100.103.45.18
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1779512772; cv=none; b=L+567MvrN71wqKhaUcnR/obHMFNvkPExriSSZobeLftX2Mr13qcnd22nSepta/p+Y4L+Ms7OX+2IdazA91/2ZsN1r/ebfti+45mUM9IK+g6hG+h9rzfaOhEmJTqyAJmvF0RuTv65KfhK8eaFmNuSYpMezlXvfmvouLl4qOcN15Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1779512772; c=relaxed/simple;
	bh=Bgtw/ubRfUuCBRqhcNKzqT5GvDNIjFqxM/0x6X+OlOQ=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=FwSEmqjNIjyGzNheIH5sDrUxWonnpbuQAnPedE9PgvuB35KfvtJ2XFsKflDtjBV3XuWSXQf1VimqHAjiQGNTXzi8gNYyqpvi4S1R4kVOPNoqZzsABI7y7WVXrO31yKNrab7oc9di3/4A72a/9o8pQANi+Zc4/Pyf7snlqLB25Fs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=Fo6BA2Ut; arc=none smtp.client-ip=100.103.45.18
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 8EC1A1F00A3A;
	Sat, 23 May 2026 05:05:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kernel.org;
	s=k20260515; t=1779512761;
	bh=MoiQSAi/kmF8G3TFbe7X24xm1Duftuwd08N3uh0+4mM=;
	h=Date:From:To:Cc:Subject:References:In-Reply-To;
	b=
Date: Fri, 22 May 2026 22:05:55 -0700
...
Message-ID: <20260523050555.GA1121518@ax162>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="U2qdHLQvhYzGZ/gb"
Content-Disposition: inline
In-Reply-To: <ahEyBrZGSVbdQxDJ@e129823.arm.com>
X-Spamd-Result: default: False [-1.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-9643-lists,linux-integrity=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
...
# Linux/arm64 7.1.0-rc4 Kernel Configuration
#
CONFIG_CC_VERSION_TEXT="ClangBuiltLinux clang version 23.0.0git (https://github.com/llvm/llvm-project.git 836fcaa4235c1145627558f5414f31e5d23cc328)"
...
CONFIG_CC_MS_EXTENSIONS="-fms-anonymous-structs"
...
CONFIG_AS_HAS_LSUI=y

#
# ARMv9.6 architectural features
#
CONFIG_ARM64_LSUI=y
# end of ARMv9.6 architectural features
...
# CONFIG_PINCTRL_GENERIC_MUX is not set
...
# CONFIG_VIDEO_OV2732 is not set
...
# CONFIG_SND_SOC_CS35L56_CAL_PERFORM_CTRL is not set
...
# CONFIG_SND_SOC_ES9356 is not set
...
# CONFIG_FPGA_MGR_EFINIX_SPI is not set
...
# CONFIG_SECURITY_HORNET is not set
CONFIG_INTEGRITY=y
...
# CONFIG_WARN_CONTEXT_ANALYSIS_ALL is not set
...
CONFIG_RV_HA_MONITOR=y
CONFIG_HA_MON_EVENTS_IMPLICIT=y
CONFIG_RV=y

Return-Path: <linux-integrity+bounces-8875-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id uLf6F8YJp2k7bgAAu9opvQ
	(envelope-from <linux-integrity+bounces-8875-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Tue, 03 Mar 2026 17:18:14 +0100
X-Original-To: lists+linux-integrity@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [IPv6:2600:3c15:e001:75::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 511AA1F3828
	for <lists+linux-integrity@lfdr.de>; Tue, 03 Mar 2026 17:18:13 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 52CDF30148B4
	for <lists+linux-integrity@lfdr.de>; Tue,  3 Mar 2026 16:18:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DE6C74D8D9B;
...
Received: from mail-pj1-f48.google.com (mail-pj1-f48.google.com [209.85.216.48])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7801A4B8DEA
	for <linux-integrity@vger.kernel.org>; Tue,  3 Mar 2026 16:17:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=pass smtp.client-ip=209.85.216.48
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1772554672; cv=pass; b=eHb9jFm/NIVL2wkNGOoWuUniQBsLzArxxK11IKJjXkI1glbQwTThgO2vE/TFCvGNIgYH9//nWmMyKXic+GTHuIAYhUbxfxdyOH4hplsAzkCYUjtbCyVFVmAWhSwYFy/ppj7AVAeL+XPeOokp3dX0Icb05hi8kIZ/o24IKkpS6/4=
...
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=paul-moore.com; spf=pass smtp.mailfrom=paul-moore.com; dkim=pass (2048-bit key) header.d=paul-moore.com header.i=@paul-moore.com header.b=AwjiNWln; arc=pass smtp.client-ip=209.85.216.48
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=paul-moore.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=paul-moore.com
Received: by mail-pj1-f48.google.com with SMTP id 98e67ed59e1d1-35982fd8910so1275400a91.1
        for <linux-integrity@vger.kernel.org>; Tue, 03 Mar 2026 08:17:48 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; t=1772554668; cv=none;
        d=google.com; s=arc-20240605;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20240605;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:dkim-signature;
        bh=vlM0HTuT+/Lu8GovscjfA3KZuqms5GnXWRMciKBvDhQ=;
        fh=oQDi1CKezZCrizGkbqlqT4GBzXRMMJo0wKM+W3vK2hA=;
        b=;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=vlM0HTuT+/Lu8GovscjfA3KZuqms5GnXWRMciKBvDhQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWgM8X2dLhhr6ZIAKdsymWCg39PBhxSriMfYt/5/mErNprE/xbmVyBmFO/6v58B2OtiEE9p4hL038OHL7hbadw=@vger.kernel.org
X-Gm-Message-State: AOJu0YwHY7Y2KJrFL3EH/iq/CXhrRES2vGQchQ0NCLSkgNSiBGPqxy05
	JOMO8i0HFQAldcRV54PMIBdnHUPBRZ/yckakg9B0iMX/idAzEi72Fvr9nSXCz5E7EAtfsvbrDnx
	MDODoYpWYWlIh0PX9zJjsS6XRiHXDB43B2gZjwHaYnBLkawxN9m+Kyg==
X-Gm-Gg: 
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-8875-lists,linux-integrity=lfdr.de];

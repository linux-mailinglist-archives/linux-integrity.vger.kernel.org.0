...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0FB17285C0
	for <lists+linux-integrity@lfdr.de>; Thu, 23 May 2019 20:18:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731275AbfEWSSc (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Thu, 23 May 2019 14:18:32 -0400
Received: from mail-ua1-f73.google.com ([209.85.222.73]:53901 "EHLO
        mail-ua1-f73.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731116AbfEWSSc (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Thu, 23 May 2019 14:18:32 -0400
Received: by mail-ua1-f73.google.com with SMTP id c5so1608971uap.20
        for <linux-integrity@vger.kernel.org>; Thu, 23 May 2019 11:18:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=date:message-id:mime-version:subject:from:to:cc;
        bh=3YA/EmJ8vKb1JygZY0dW4qrr4WsKoK8tbpu0I1wyYOE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:date:message-id:mime-version:subject:from:to:cc;
        bh=3YA/EmJ8vKb1JygZY0dW4qrr4WsKoK8tbpu0I1wyYOE=;
        b=
X-Gm-Message-State: APjAAAXmE5ijFN4en62z8mE3oHK0eDJ2CjRUlCYt25wUf25LApqSvPOh
        6tiy9m3PiwKGrUQa2SKm21mGfQ3PDIrZ32L0n1qfyNdp01+hSlZ2OxszbzUwZRE6Os5vwQYx6fH
        DM5+ZkgQf8+X3R/V3hNG1VcQHOAFgR/18CalW5IsK+AXZA43b/RgXIYBA27DljfPFy+6Yl16r99
        6GLzI/OTOvzGfRWMfeCr8=
X-Google-Smtp-Source: APXvYqwAKg+pAq799hOBzegenK02rrdaqKdZDuiGm7LsHz2WUYfPnR1H8IVwWKtQWh4d9NrR6I8BOdyAblZtMBVhPF0jOw==
X-Received: by 2002:ab0:7346:: with SMTP id k6mr12278224uap.89.1558635511145;
 Thu, 23 May 2019 11:18:31 -0700 (PDT)
Date:   Thu, 23 May 2019 11:18:27 -0700
Message-Id: <20190523181827.207274-1-matthewgarrett@google.com>
Mime-Version: 1.0
X-Mailer: git-send-email 2.22.0.rc1.257.g3120a18244-goog
Subject: [PATCH V2] IMA: Allow profiles to define the desired IMA template

Return-Path: <linux-integrity+bounces-170-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B3B977F3933
	for <lists+linux-integrity@lfdr.de>; Tue, 21 Nov 2023 23:32:01 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id E4A841C20EDB
	for <lists+linux-integrity@lfdr.de>; Tue, 21 Nov 2023 22:32:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4440B5B1F9;
	Tue, 21 Nov 2023 22:32:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="DiFkeWCH"
X-Original-To: linux-integrity@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 231455B1FD
	for <linux-integrity@vger.kernel.org>; Tue, 21 Nov 2023 22:32:00 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 91C41C433C7;
	Tue, 21 Nov 2023 22:31:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1700605920;
	bh=mT7thg9ZbzupbS+Grx7/4OqnuyLdBxSWMmRGyXsyjlQ=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
...
Subject: [PATCH v5 5/8] tpm: Store the length of the tpm_buf data separately.
Date: Wed, 22 Nov 2023 00:31:17 +0200
Message-ID: <20231121223130.30824-6-jarkko@kernel.org>

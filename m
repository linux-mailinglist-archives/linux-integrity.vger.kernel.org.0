Return-Path: <linux-integrity+bounces-3424-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D72E9963988
	for <lists+linux-integrity@lfdr.de>; Thu, 29 Aug 2024 06:53:35 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 90DA7285D59
	for <lists+linux-integrity@lfdr.de>; Thu, 29 Aug 2024 04:53:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1F5B4145336;
	Thu, 29 Aug 2024 04:53:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ucr.edu header.i=@ucr.edu header.b="iXAsLM1y";
...
Received: from mx2.ucr.edu (mx2.ucr.edu [138.23.62.3])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9C6271870
	for <linux-integrity@vger.kernel.org>; Thu, 29 Aug 2024 04:53:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=138.23.62.3
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1724907209; cv=none; b=MJLkW78RVM2DsEjcg8X8nDt32VrVGvPQnkxlWguGgWMAhkPFBrNyWZZVDinct8PG9aYw/DN+aOK5NKCdiYGdxhpmJr7XLBtqo0cZxRJlraPyYgiHswQnOgDUhlmFTTcQhK1hamM4Opk+XQVpswI5unJ2qN8dMH8/O4F47kur9Mc=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ucr.edu; spf=pass smtp.mailfrom=ucr.edu; dkim=pass (2048-bit key) header.d=ucr.edu header.i=@ucr.edu header.b=iXAsLM1y; dkim=pass (1024-bit key) header.d=ucr.edu header.i=@ucr.edu header.b=MAyWY/11; arc=none smtp.client-ip=138.23.62.3
...
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  ...
  h=dkim-signature:x-google-dkim-signature:
   ...
   x-cse-msgguid;
  bh=vWRN8GDk/PZWv9onUtIniPDEz+cH5h9xFJ3pIAd7/jk=;
  b=iXAsLM1ywHLY4NCRhypZ7EpMKkj2+BuxHyWkvrszI7nEmqTJY59KLtoU
   WyuqYBQdlEhxSFrSfxqL7yiIExG/AMKmy8rr6HXfLZuES4jHfxUxwo7/D
   +umBUJqz+jtEYPANwR8hEKtEQanSLejqovjtazE58ZbrUmmQLXVOJ7V05
   sdcqWh2Nc7nCwDvUdZ609TQ1v3ndtLJZkhfpqj3f2W7tdWjb/SBPT3WNk
   WXbikH6md+jGPM6Sbl6JcT1e91u9ANXCEVBs7LHuE3QSEsdtbvoP2kSvH
   Ub0AQfIFEiE0ayrRxzmo6C5WXxo2Pap281U3JMjCRnL1JKWiyEaUmQp3D
   g==;
X-CSE-ConnectionGUID: b3iQ4WQ3R/K6DN2bvejC3A==
X-CSE-MsgGUID: srapqmTPT46f/Qgk2EIjvw==
Received: from mail-il1-f198.google.com ([209.85.166.198])
  by smtp2.ucr.edu with ESMTP/TLS/TLS_AES_256_GCM_SHA384; 28 Aug 2024 21:53:26 -0700
Received: by mail-il1-f198.google.com with SMTP id e9e14a558f8ab-39d5537a62dso2634835ab.2
        for <linux-integrity@vger.kernel.org>; Wed, 28 Aug 2024 21:53:25 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=LvbdCIAZoPSRQIRiURrONGlyZEULx7vGUPaM6+ggKQU=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWKZyl3UvwKNf0VGAdr4dvLm0sUR/zjpANwVDehgY1yTBKiPFDQF5SwAsGYe+dxvENvkpdE4OWRgKzpUWnXTJU=@vger.kernel.org
X-Gm-Message-State: AOJu0YwF2rAUnYPMYZwK1Jbst6GV9vPf5q9akZARWjjkwQhLPEDHRP/g
	L4EK2CoW45z2Xe6OUSS8qMUuMBgTcCE98KVmdAONFfUTDn/+R+DBQJg3JjRNU3M+2ZwnUQowKWv
	XnzSjGv48J1yJj1cfRCfBXosJ7qr/knxsG+d6vjUkBruzX9XBB7CgQvna0/zBD4takADci9A4N/
	KdrPQnKkiYyTMBO38CEyRDcSTcE6fP8Fqp7zpPtijXdQ==
X-Received: by 2002:a92:cd82:0:b0:396:d1c5:e5f with SMTP id e9e14a558f8ab-39f377cb444mr22317755ab.6.1724907205106;

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0CB366A87FE
	for <lists+linux-integrity@lfdr.de>; Thu,  2 Mar 2023 18:39:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230143AbjCBRjK (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Thu, 2 Mar 2023 12:39:10 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45932 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229873AbjCBRjJ (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Thu, 2 Mar 2023 12:39:09 -0500
Received: from frasgout13.his.huawei.com (frasgout13.his.huawei.com [14.137.139.46])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 559FF1258A
        for <linux-integrity@vger.kernel.org>; Thu,  2 Mar 2023 09:39:02 -0800 (PST)
Received: from mail02.huawei.com (unknown [172.18.147.228])
        by frasgout13.his.huawei.com (SkyGuard) with ESMTP id 4PSJ5n36xHz9v7J4
        for <linux-integrity@vger.kernel.org>; Fri,  3 Mar 2023 01:30:21 +0800 (CST)
Received: from huaweicloud.com (unknown [10.204.63.22])
        by APP1 (Coremail) with SMTP id LxC2BwDXVwMh3wBkku1mAQ--.11262S2;
        Thu, 02 Mar 2023 18:38:47 +0100 (CET)
From:   Roberto Sassu <roberto.sassu@huaweicloud.com>
To:     zohar@linux.ibm.com, dmitry.kasatkin@gmail.com
Cc:     linux-integrity@vger.kernel.org, vt@altlinux.org, pvorel@suse.cz,
        stefanb@linux.ibm.com, Roberto Sassu <roberto.sassu@huawei.com>
Subject: [PATCH ima-evm-utils v4] Add ima_policy_check.awk and ima_policy_check.test
Date:   Thu,  2 Mar 2023 18:38:31 +0100
Message-Id: <20230302173831.613584-1-roberto.sassu@huaweicloud.com>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-CM-TRANSID: LxC2BwDXVwMh3wBkku1mAQ--.11262S2
X-Coremail-Antispam: 1UD129KBjvAXoWfZw4fKFW3ZrWDZw1DuFWDXFb_yoW8KF1DCo
        WfKrs8tFW8KFW3C34UCFsrtrWUWa4Sgrs7JrW5JF1YyFn2gr4kKa95Xw15ZFWkGan8XFya
        ka4xW3s3JFZ7Gas3n29KB7ZKAUJUUUUU529EdanIXcx71UUUUU7v73VFW2AGmfu7bjvjm3
...
X-CM-SenderInfo: purev21wro2thvvxqx5xdzvxpfor3voofrz/1tbiAQAEBF1jj4ojJgAAs-
...
v3:
- Consider rules with different function values as overlapping (suggested
  by Mimi)
- Distinguish between < > operators and ^ modifier; only with the < >
  operators, if supported, disjoint sets could be found and thus
  non-overlapping conditions can be detected; with the ^ modifier,
  overlapping must be always reported
- Better express that rules with aliases are considered equivalent to those
  with their source (suggested by Mimi)
- Remove non-overlapping by func test, and add a new one with different func
  values, appraise and a do action
- Add additional text in the test description for modifiers, operators and
  aliases (suggested by Mimi)
...
- Adjust tests according to the new goal, which is to detect overlapping
 ...
 ci/tumbleweed.sh            |   3 +-
 tests/Makefile.am           |   2 +-
 tests/ima_policy_check.awk  | 211 +++++++++++++++++++++++++++++++

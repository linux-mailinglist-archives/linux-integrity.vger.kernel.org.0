...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B44DE11607B
	for <lists+linux-integrity@lfdr.de>; Sun,  8 Dec 2019 06:14:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725268AbfLHFOG (ORCPT <rfc822;lists+linux-integrity@lfdr.de>);
        Sun, 8 Dec 2019 00:14:06 -0500
Received: from bedivere.hansenpartnership.com ([66.63.167.143]:58132 "EHLO
        bedivere.hansenpartnership.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1725263AbfLHFOG (ORCPT
        <rfc822;linux-integrity@vger.kernel.org>);
        Sun, 8 Dec 2019 00:14:06 -0500
Received: from localhost (localhost [127.0.0.1])
        by bedivere.hansenpartnership.com (Postfix) with ESMTP id CCAB58EE111;
        Sat,  7 Dec 2019 21:14:05 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=hansenpartnership.com;
        s=20151216; t=1575782045;
        bh=2gvhvXWGa4bcA8svhyiWJv2SvClez4V4TGBJM8tq5Ro=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=nM+gz3bj/Bnchkb9IvnO5Bxj1VH0RfGlAxsO8jTSsScJfOsXoEtDGIrowwCFzLJvQ
         deQzDN4SESCdL5xRTXm1rtqGB2I8v9+EHVqAgWsMk0UcaRpxkwVGn9sl7HlPImhfbm
         xuTx/PQurGDC3edAJ/Kth43lQxZRa6PKwQwlm+NQ=
Received: from bedivere.hansenpartnership.com ([127.0.0.1])
        by localhost (bedivere.hansenpartnership.com [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id i4CvEn_NYOCt; Sat,  7 Dec 2019 21:14:05 -0800 (PST)
Received: from jarvis.lan (unknown [50.35.76.230])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by bedivere.hansenpartnership.com (Postfix) with ESMTPSA id 696B58EE109;
        Sat,  7 Dec 2019 21:14:05 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=hansenpartnership.com;
        s=20151216; t=1575782045;
        bh=2gvhvXWGa4bcA8svhyiWJv2SvClez4V4TGBJM8tq5Ro=;
        ...
        b=nM+gz3bj/Bnchkb9IvnO5Bxj1VH0RfGlAxsO8jTSsScJfOsXoEtDGIrowwCFzLJvQ
         deQzDN4SESCdL5xRTXm1rtqGB2I8v9+EHVqAgWsMk0UcaRpxkwVGn9sl7HlPImhfbm
         xuTx/PQurGDC3edAJ/Kth43lQxZRa6PKwQwlm+NQ=
Message-ID: <1575782044.14069.18.camel@HansenPartnership.com>
Subject: [PATCH 8/8] security: keys: trusted: implement counter/timer policy
From:   James Bottomley <James.Bottomley@HansenPartnership.com>
To:     linux-integrity@vger.kernel.org
Cc:     Mimi Zohar <zohar@linux.ibm.com>,
        Jarkko Sakkinen <jarkko.sakkinen@linux.intel.com>
Date:   Sat, 07 Dec 2019 21:14:04 -0800

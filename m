Return-Path: <linux-integrity+bounces-9550-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id +Ak4AnOOB2rB8AIAu9opvQ
	(envelope-from <linux-integrity+bounces-9550-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Fri, 15 May 2026 23:21:55 +0200
X-Original-To: lists+linux-integrity@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [104.64.211.4])
	by mail.lfdr.de (Postfix) with ESMTPS id 05556557DD1
	for <lists+linux-integrity@lfdr.de>; Fri, 15 May 2026 23:21:53 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 3EC683030F76
	for <lists+linux-integrity@lfdr.de>; Fri, 15 May 2026 21:15:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 08A673F8704;
...
Received: from mail-dl1-f46.google.com (mail-dl1-f46.google.com [74.125.82.46])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B2AD83F6C5A
	for <linux-integrity@vger.kernel.org>; Fri, 15 May 2026 21:14:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=74.125.82.46
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1778879699; cv=none; b=AovWPXTs73BzpF4M3yUttcv3rmuA6H8fuv7kEjcLA4WvxOGRU5A37uAbnYmSuwqJKzTyuBSBHM+lzWca0rsRDgs0TqCbaYDvdUdzTbHEhhKwH0ERgzYjz8bv0eY3nMsblKN/SUQMu/HX/XrcriohJoXow7XCRrCfb60d5GDrsFU=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=qCrdw4Ik; arc=none smtp.client-ip=74.125.82.46
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-dl1-f46.google.com with SMTP id a92af1059eb24-1331e851faaso114370c88.1
        for <linux-integrity@vger.kernel.org>; Fri, 15 May 2026 14:14:56 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=yYV487dim1u7McKHcszztZC/VNez+ruEau/ZSoQzK6U=;
        b=
X-Forwarded-Encrypted: i=1; AFNElJ/RnRDi+n1gs1u9Nr5OYkQdGYwlAxMl4BY/ejSoUv1cyaqXMsv++swzqEPPIOz3huGszVLXGNp1qUN9nPz9fcs=@vger.kernel.org
X-Gm-Message-State: AOJu0Ywm5yrr1o/lk7VhYn+0Syzwu1QhipZbPLakbm696o0ej6bImuB1
	ZRjm93dedBetu9rhmr+UVY4TAb87b6WVeG7YTRhzF/cWLmjn0Sf1KIit
X-Gm-Gg: 
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-9550-lists,linux-integrity=lfdr.de];
	...
	HAS_WP_URI(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[trustedcomputinggroup.org:url,sin.lore.kernel.org:helo,sin.lore.kernel.org:rdns,fosdem.org:url,amd.com:url,intel.com:url,trenchboot.org:url,apertussolutions.com:email]

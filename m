Return-Path: <linux-integrity+bounces-5866-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id E0446A886C3
	for <lists+linux-integrity@lfdr.de>; Mon, 14 Apr 2025 17:18:53 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 2BA68189F532
	for <lists+linux-integrity@lfdr.de>; Mon, 14 Apr 2025 14:57:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 344702522B4;
	Mon, 14 Apr 2025 14:57:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="IdVCVA2j"
X-Original-To: linux-integrity@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 154DB2522B2
	for <linux-integrity@vger.kernel.org>; Mon, 14 Apr 2025 14:57:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1744642638; cv=none; b=m8vNjUcUjMgvuEFLVGEsjY2YO20dUkr/0zN4aSpXq3abcfr7rIZQKceVAEPyVpTcODyAQBk+9XkDMSJ995TiMeNEDh3iELuEqFRmn4pRtEnuzm8vOndPLkTOL1w2kOaxlBRpDQojCSFQpxc4nXTwxYsSnJO43BAmLCOyRSH9+cc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1744642638; c=relaxed/simple;
	bh=6r+MscL49X6maR2bi1z1YeY7IVYIxDyEwomnrbpDzKw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=eXPk+Oi37enEL6lpjn8Tp2eypmFuGhc4bsxvkHdEyPj3Cksitdcq4tfYPfaY/YgtHHuXJTV9tzbzns22+rgLXN310HySlbGZNOky3Uq7VQKPKQ4IuquBNoChIkStbw8YJaCU6j2bisfL12RV+dvnvqI3XhNatq4LpBIGAq0OuVY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=IdVCVA2j; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=IdVCVA2j2UKGz3Wooz93FfXVKVn0wTlCqiCEphbLwOP0UfOBsWdC1I5jQE9RoNEo3TUM+o
	aUDLb8UZhmsHh9a0MSpCGodh3WxXQOuqBRn/vc2WSU7sw70cPvKymCu0HbdkriMQVTseTc
	o76TmfBxHC5qQrbwbEJ7C6KmvEHqi6k=
Received: from mail-wm1-f71.google.com (mail-wm1-f71.google.com
 [209.85.128.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-227-oiaLiygmMGiYdiRvVpZCBA-1; Mon, 14 Apr 2025 10:57:13 -0400
X-MC-Unique: oiaLiygmMGiYdiRvVpZCBA-1
X-Mimecast-MFC-AGG-ID: oiaLiygmMGiYdiRvVpZCBA_1744642632
Received: by mail-wm1-f71.google.com with SMTP id 5b1f17b1804b1-43efa869b19so31223145e9.2
        for <linux-integrity@vger.kernel.org>; Mon, 14 Apr 2025 07:57:12 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=u+GxiDq9Oeu84I44/bSM7g+y4sCBZzfShQDAFCXqXxc=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCW0lZ+NDTBfO9W1DtJSuQWKxRY7cMmPpq6fTsRYCsV0Ay7wsePaPaJcrPssWhOCWY6IbnCfN8t2A6mVb9FD2jk=@vger.kernel.org
X-Gm-Message-State: AOJu0YwOKuOQ0Af1yrP0BrKKg7mxeRvZDPv/wsXf2fcr4u+Y3wALp5pE
	i65gysmJNZJZKykm2UXkTAM5ZUXsB89pb0zXZlxLreWvyk/ikXPnK7DrwL6PePxB1iy8T8aATuv
	WKjRkZAul8hfRgxlNKUHYuGEbKmVsBtdxctBnkWfSEiImVm0U28gwM0AjFujKfjj2Bw==
X-Gm-Gg: 
	MGb+ut+SuY46dUzXDksMTMYT
X-Received: by 2002:a05:600c:83c6:b0:43d:b85:1831 with SMTP id 5b1f17b1804b1-43f3a7d8c5emr128943945e9.0.1744642631390;

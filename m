Return-Path: <linux-integrity+bounces-9545-lists+linux-integrity=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-integrity@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gMfmAweQB2rB8AIAu9opvQ
	(envelope-from <linux-integrity+bounces-9545-lists+linux-integrity=lfdr.de@vger.kernel.org>)
	for <lists+linux-integrity@lfdr.de>; Fri, 15 May 2026 23:28:39 +0200
X-Original-To: lists+linux-integrity@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E1635581A5
	for <lists+linux-integrity@lfdr.de>; Fri, 15 May 2026 23:28:38 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 7978B3028004
	for <lists+linux-integrity@lfdr.de>; Fri, 15 May 2026 21:15:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BBED13ED5BE;
	Fri, 15 May 2026 21:14:45 +0000 (UTC)
...
Received: from mail-dy1-f173.google.com (mail-dy1-f173.google.com [74.125.82.173])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D316A33F8A5
	for <linux-integrity@vger.kernel.org>; Fri, 15 May 2026 21:14:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=74.125.82.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1778879685; cv=none; b=ouVMy7J+WtozSRmNqm12kRbt1xgtRuQxMGleHvCMuz4iXnGX1MpHy2jMdEWvAfO7aB+Sbf6+8Krx2Nzab0/RoCnajg9My1f3jVIdTco3B/H/hgHk0MfCcf0V4oEaQekRbb6887GDl4d1vLxOWW/CRa/Yw1YJTNVgISAfUPuM+v4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1778879685; c=relaxed/simple;
	bh=KmMuFaZ47SktGkwlkyAAHZ+8pIrSgOx69g0xNUTeidE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Vqwhuw9GdbPdPW7DSY8S4N7mg8wTNAX7EVycvVUZQH1yYkSQqxjAJ4kXMb27b0/DrtxtysLF7oxDCrAfptPWVs5mM2JKjcOKqT2rxK9D6QCx1YShG1CB2WN1vAVGnlshmy3JOHpjBiHCiqLBW2Cwa/Lu0rU2tBoRQ21DfnSNJHs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=XVk3x7/3; arc=none smtp.client-ip=74.125.82.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-dy1-f173.google.com with SMTP id 5a478bee46e88-2ff5472f263so305738eec.1
        for <linux-integrity@vger.kernel.org>; Fri, 15 May 2026 14:14:39 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=OlxyTJHK1qXe4zH9KCCXFkLyu/Bt9I2QGkqATJMamdk=;
        b=
X-Forwarded-Encrypted: i=1; AFNElJ825sya9ZNrFsIBTp3iI39ZuqdVVDBgn7Hf97uP7q8iZeDE/qvyMl8WBHnoAex7VcsilQLLhOC6c8E7fI1ItYg=@vger.kernel.org
X-Gm-Message-State: AOJu0YxGdkUqkrZ3u6fpscMNMNTLnUGcXqcIyJA1iBJSzaDDIuUO6Dah
	IcOM900g+iFUsNODEAZ7IX/06dq1FIjSIZe4Q/8VdD2dHARZbSsevbAz
X-Gm-Gg: 
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-9545-lists,linux-integrity=lfdr.de];
	FROM_HAS_DN(0.00)[];

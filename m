Return-Path: <linux-integrity+bounces-2868-lists+linux-integrity=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-integrity@lfdr.de
Delivered-To: lists+linux-integrity@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B8E9990DFC6
	for <lists+linux-integrity@lfdr.de>; Wed, 19 Jun 2024 01:21:15 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 48588B21D00
	for <lists+linux-integrity@lfdr.de>; Tue, 18 Jun 2024 23:21:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C926F17E476;
...
Received: from mail-yb1-f178.google.com (mail-yb1-f178.google.com [209.85.219.178])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2E8C6178CCD
	for <linux-integrity@vger.kernel.org>; Tue, 18 Jun 2024 23:21:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.178
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1718752867; cv=none; b=D0BoTjmPM98khUW4uGGkwFd7emL5vJln4EE4F5HSBOejVLAOKdcggFNsHWi9HaBPzfkcfx3IJEqCQfkw5CVm2vq5QL/47vopBqdEBZHyySMBE6HSC6181+8yfukBmjk4ZQZwp5CPL9k3pP1tyPt0Pd8LuBZpm+q7KNg+605v/Xk=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=paul-moore.com; spf=pass smtp.mailfrom=paul-moore.com; dkim=pass (2048-bit key) header.d=paul-moore.com header.i=@paul-moore.com header.b=VHXKe04i; arc=none smtp.client-ip=209.85.219.178
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=paul-moore.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=paul-moore.com
Received: by mail-yb1-f178.google.com with SMTP id 3f1490d57ef6-dff0c685371so5366049276.2
        for <linux-integrity@vger.kernel.org>; Tue, 18 Jun 2024 16:21:05 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=eiWmKBBXMD92k+n8gcYpFFSycdOAu2SpOI6WWatC5Kk=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUJ5qtOyW8fotoZdIAJm6cODGTRdBfTEFomNb5n0h3bG1+bu61m1MQdZUOOKrS0VRt7lHg4BGmJ51XXGNpl7LS5Xl/8IjmB8HRGh61T+7zZ
X-Gm-Message-State: AOJu0YwUkF6OXwMOriKoinDK98kOy+q4cDjbDDO0n7rtOy2cBsZqI7w8
	Xpnzy+d2smrFUuVIuYxjK5M63hJqPx6ghyY3wOiryO4+bt6/oCPF54oXJOFzYfFx0eipEs9z7JK
	syznWwczSLIJPzvDpN+1AswCOjhEUTnYfTjdoI1TAnKJ8ElX3Cw==
